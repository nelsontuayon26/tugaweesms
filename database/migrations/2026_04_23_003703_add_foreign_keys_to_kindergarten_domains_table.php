...
return new class extends Migration
{
    ...
    {
        Schema::table('kindergarten_domains', function (Blueprint $table) {
    ...
    {
        Schema::table('kindergarten_domains', function (Blueprint $table) {
            $table->dropForeign('kindergarten_domains_school_year_id_foreign');
            $table->dropForeign('kindergarten_domains_student_id_foreign');
        });
    }
};
