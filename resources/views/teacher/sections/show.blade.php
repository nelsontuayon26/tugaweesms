    ...
    <div class="flex-1 lg:ml-72 transition-all duration-300">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-slate-800">{{ $section->capacity ?? 'N/A' }}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <!-- Attendance Card -->
                <a href="{{ route('teacher.sections.attendance', $section) }}" class="block bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md hover:border-amber-200 transition-all group">
                    <div class="flex items-center gap-4">
                ...
                <!-- Grades Card -->
                <a href="{{ route('teacher.sections.grades', $section) }}" class="block bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md hover:border-emerald-200 transition-all group">
                    <div class="flex items-center gap-4">
                ...
                <!-- Core Values Card -->
                <a href="{{ route('teacher.sections.core-values.index', $section) }}" class="block bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md hover:border-rose-200 transition-all group">
                    <div class="flex items-center gap-4">
            ...
            <div class="mt-6 bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div class="p-3 bg-slate-50 rounded-lg">
                        ...
                        <p class="font-medium text-slate-800">{{ $section->gradeLevel->name ?? 'N/A' }}</p>
                    </div>
                    <div class="p-3 bg-slate-50 rounded-lg">
                        <p class="text-slate-500 text-xs mb-1">School Year</p>
                        <p class="font-medium text-slate-800">{{ $section->schoolYear->name ?? 'N/A' }}</p>
                    </div>
                    <div class="p-3 bg-slate-50 rounded-lg">
                        <p class="text-slate-500 text-xs mb-1">Adviser</p>
                        <p class="font-medium text-slate-800">{{ $section->teacher->full_name ?? 'N/A' }}</p>
                    </div>
                    <div class="p-3 bg-slate-50 rounded-lg">
                        <p class="text-slate-500 text-xs mb-1">Status</p>
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium {{ $section->is_active ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700' }}">
