                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 glass-card rounded-2xl p-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3 mt-1">
                                        <input type="date" 
                                               ...
                                               onchange="window.location.href='{{ route('teacher.dashboard') }}?section_id={{ $activeSection->id ?? '' }}&date=' + this.value"
                                        ...
                                        <button type="button" 
                                                onclick="window.location.href='{{ route('teacher.dashboard') }}?section_id={{ $activeSection->id ?? '' }}'"
                            ...
                            <form id="attendanceForm" onsubmit="event.preventDefault();">
                                @csrf
                                <input type="hidden" name="date" id="attendanceDateInput" value="{{ $attendanceDate }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="glass-card rounded-2xl p-6">
                                ...
                                <form action="{{ route('teacher.dashboard') }}" method="GET" id="sectionForm" class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('teacher.sections.show', $activeSection) }}" 
                    ...
                    <div class="glass-card rounded-2xl p-6">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-1">{{ $currentQuarter ? $currentQuarter . ' Quarter' : 'Current Quarter' }} • Real-time grade analysis</p>
                            </div>
                            <div class="flex gap-2">
                                ...
                                <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-xl hover:bg-indigo-50 transition-all border border-transparent hover:border-indigo-200 cursor-pointer group">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="mt-2 flex items-center gap-3 text-xs">
                                            <span class="bg-white px-2 py-1 rounded border border-slate-200">WW: {{ $grade->ww_weighted ?? 0 }}%</span>
                                            <span class="bg-white px-2 py-1 rounded border border-slate-200">PT: {{ $grade->pt_weighted ?? 0 }}%</span>
                                            <span class="font-bold text-slate-700 bg-indigo-50 px-2 py-1 rounded border border-indigo-100">Final: {{ $grade->final_grade ?? 0 }}</span>
                                        </div>
                                    </div>
                                </div>
                                @empty
