...
<head>
    ...
    <title>Edit User - {{ $isAdminLevel ? 'Admin / Principal' : '' }} - Tugawe Elem</title>
    <!-- Font Awesome 6 CDN -->
            ...
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-0.5">Update {{ $isAdminLevel ? 'admin / principal' : 'user' }} information</p>
                    </div>
                </div>
            </div>
        </header>
                        ...
                        <div class="glass-card p-6 animate-fade-in-up animate-delay-2">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500">Manage {{ $isAdminLevel ? 'admin / principal role' : 'role' }} and status</p>
                                </div>
                            </div>
