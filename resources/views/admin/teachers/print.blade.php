...
<body>
    <div class="no-print">
        ...
        <p style="margin:6px 0 0;font-size:11px;color:#64748b;">{{ $teachers->count() }} teacher profile(s)</p>
    </div>
    ...
    <div class="teacher-profile">
        <div class="sf1-header">
            <div class="header-text">
                ...
                <div class="meta">Teacher Profile Record &middot; Generated {{ now()->format('M d, Y') }}</div>
            </div>
            <div class="photo-box">
                @if(!empty($photos[$teacher->id]))
                    <img src="{{ $photos[$teacher->id] }}" alt="">
                @else
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value" colspan="3">{{ $teacher->full_name }}</td>
            </tr>
            <tr>
                <td class="label">DepEd ID</td>
                <td class="value">{{ $teacher->deped_id ?: '—' }}</td>
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->place_of_birth ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Gender</td>
                <td class="value">{{ $teacher->gender ?: '—' }}</td>
                <td class="label">Civil Status</td>
                <td class="value">{{ $teacher->civil_status ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Nationality</td>
                <td class="value">{{ $teacher->nationality ?: '—' }}</td>
                <td class="label">Religion</td>
                <td class="value">{{ $teacher->religion ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Blood Type</td>
                <td class="value">{{ $teacher->blood_type ?: '—' }}</td>
                <td class="label">Status</td>
                <td class="value">{{ $teacher->current_status ?: ($teacher->status ?: '—') }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->mobile_number ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Telephone</td>
                <td class="value">{{ $teacher->telephone_number ?: '—' }}</td>
                <td class="label">Region</td>
                <td class="value">{{ $teacher->region ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Address</td>
                <td class="value" colspan="3">{{ implode(', ', array_filter([$teacher->street_address, $teacher->barangay, $teacher->city_municipality, $teacher->province, $teacher->zip_code])) ?: '—' }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->emergency_contact_relationship ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Number</td>
                <td class="value">{{ $teacher->emergency_contact_number ?: '—' }}</td>
                <td class="label">Address</td>
                <td class="value">{{ $teacher->emergency_contact_address ?: '—' }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->employment_status ?: '—' }}</td>
                <td class="label">Date Hired</td>
                <td class="value">{{ $hired ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Date Regularized</td>
                <td class="value">{{ $regularized ?: '—' }}</td>
                <td class="label">Teaching Level</td>
                <td class="value">{{ $teacher->teaching_level ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Position</td>
                <td class="value">{{ $teacher->position ?: '—' }}</td>
                <td class="label">Designation</td>
                <td class="value">{{ $teacher->designation ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Department</td>
                <td class="value">{{ $teacher->department ?: '—' }}</td>
                <td class="label">Class Adviser</td>
                <td class="value">{{ $teacher->is_class_adviser ? 'Yes' : 'No' }}</td>
            </tr>
            <tr>
                <td class="label">Advisory Class</td>
                <td class="value">{{ $teacher->advisory_class ?: '—' }}</td>
                <td class="label">Years Exp.</td>
                <td class="value">{{ $teacher->years_of_experience ?: '—' }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->salary_grade ?: '—' }}</td>
                <td class="label">Step Increment</td>
                <td class="value">{{ $teacher->step_increment ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Basic Salary</td>
                <td class="value">{{ $teacher->basic_salary ? '₱'.number_format($teacher->basic_salary, 2) : '—' }}</td>
                <td class="label">Bank Account</td>
                <td class="value">{{ $teacher->bank_name ? ($teacher->bank_name.' / '.$teacher->bank_account_number) : '—' }}</td>
            </tr>
            <tr>
                <td class="label">Highest Education</td>
                <td class="value">{{ $teacher->highest_education ?: '—' }}</td>
                <td class="label">Degree Program</td>
                <td class="value">{{ $teacher->degree_program ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Major</td>
                <td class="value">{{ $teacher->major ?: '—' }}</td>
                <td class="label">School Graduated</td>
                <td class="value">{{ $teacher->school_graduated ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Year Graduated</td>
                <td class="value">{{ $teacher->year_graduated ?: '—' }}</td>
                <td class="label">Honors</td>
                <td class="value">{{ $teacher->honors_received ?: '—' }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->prc_license_number ?: '—' }}</td>
                <td class="label">License Validity</td>
                <td class="value">{{ $prcValidity ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">LET Passer</td>
                <td class="value">{{ $teacher->let_passer ? 'Yes' : 'No' }}</td>
                <td class="label">Board Rating</td>
                <td class="value">{{ $teacher->board_rating ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">TESDA NC</td>
                <td class="value">{{ $teacher->tesda_nc ?: '—' }}</td>
                <td class="label">TESDA Sector</td>
                <td class="value">{{ $teacher->tesda_sector ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Previous School</td>
                <td class="value">{{ $teacher->previous_school ?: '—' }}</td>
                <td class="label">Previous Position</td>
                <td class="value">{{ $teacher->previous_position ?: '—' }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->gsis_id ?: '—' }}</td>
                <td class="label-narrow">Pag-IBIG</td>
                <td class="value">{{ $teacher->pagibig_id ?: '—' }}</td>
                <td class="label-narrow">PhilHealth</td>
                <td class="value">{{ $teacher->philhealth_id ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label-narrow">SSS</td>
                <td class="value">{{ $teacher->sss_id ?: '—' }}</td>
                <td class="label-narrow">TIN</td>
                <td class="value">{{ $teacher->tin_id ?: '—' }}</td>
                <td class="label-narrow">Pag-IBIG RTN</td>
                <td class="value">{{ $teacher->pagibig_rtn ?: '—' }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value">{{ $teacher->spouse_occupation ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Spouse Contact</td>
                <td class="value">{{ $teacher->spouse_contact ?: '—' }}</td>
                <td class="label">Children</td>
                <td class="value">{{ $teacher->number_of_children ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Father's Name</td>
                <td class="value">{{ $teacher->father_name ?: '—' }}</td>
                <td class="label">Father's Occupation</td>
                <td class="value">{{ $teacher->father_occupation ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Mother's Name</td>
                <td class="value">{{ $teacher->mother_name ?: '—' }}</td>
                <td class="label">Mother's Occupation</td>
                <td class="value">{{ $teacher->mother_occupation ?: '—' }}</td>
            </tr>
        </table>
        ...
        <table class="sf1-table">
            ...
            <tr>
                ...
                <td class="value" colspan="3">{{ $sections ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Subjects</td>
                <td class="value" colspan="3">{{ $subjects ?: '—' }}</td>
            </tr>
            <tr>
                <td class="label">Documents</td>
                <td class="doc-cell" colspan="3">
                    Resume: <b class="{{ $teacher->resume_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->resume_path ? 'YES' : 'NO' }}</b> &nbsp;|&nbsp;
                    PRC ID: <b class="{{ $teacher->prc_id_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->prc_id_path ? 'YES' : 'NO' }}</b> &nbsp;|&nbsp;
                    Transcript: <b class="{{ $teacher->transcript_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->transcript_path ? 'YES' : 'NO' }}</b> &nbsp;|&nbsp;
                    Clearance: <b class="{{ $teacher->clearance_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->clearance_path ? 'YES' : 'NO' }}</b> &nbsp;|&nbsp;
                    Medical: <b class="{{ $teacher->medical_cert_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->medical_cert_path ? 'YES' : 'NO' }}</b> &nbsp;|&nbsp;
                    NBI: <b class="{{ $teacher->nbi_clearance_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->nbi_clearance_path ? 'YES' : 'NO' }}</b> &nbsp;|&nbsp;
                    Service Record: <b class="{{ $teacher->service_record_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->service_record_path ? 'YES' : 'NO' }}</b> &nbsp;|&nbsp;
                    Photo: <b class="{{ $teacher->photo_path ? 'doc-yes' : 'doc-no' }}">{{ $teacher->photo_path ? 'YES' : 'NO' }}</b>
                </td>
            </tr>
            @if($teacher->remarks)
            <tr>
                <td class="label">Remarks</td>
                <td class="value" colspan="3">{{ $teacher->remarks }}</td>
            </tr>
            @endif
        </table>
        ...
        <div style="margin-top:24px;font-size:8px;text-align:center;">
            <span style="border-top:1px solid #000;padding-top:2px;display:inline-block;min-width:200px;">
                {{ $schoolHead ?: 'Authorized Signatory' }}
            </span>
