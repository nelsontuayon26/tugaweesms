                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="guardian_name" class="form-input" placeholder="Full name" value="{{ old('guardian_name') }}" required>
                            </div>

                            <div>
                                <label class="form-label required">Relationship to Student</label>
                                <input type="text" name="guardian_relationship" class="form-input" placeholder="e.g., Grandmother, Uncle" value="{{ old('guardian_relationship') }}" required>
                            </div>
