    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 modal-pop">
        ...
        <div class="p-6">
            <p class="text-slate-600 mb-4">
                Are you sure you want to delete <strong>{{ $event->title }}</strong>? This will permanently remove it from the system.
            </p>
        </div>
...
<div id="successModal" class="fixed inset-0 z-[9999] hidden flex items-center justify-center bg-black/50 backdrop-blur-sm">
    <div class="bg-white rounded-2xl shadow-2xl max-w-sm w-full mx-4 modal-pop">
        ...
        <div class="p-6 text-center">
            ...
            <a href="{{ route('admin.events.index') }}" class="w-full px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-xl transition-colors inline-block">
                Continue
            </a>
        </div>
    </div>
