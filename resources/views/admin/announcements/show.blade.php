...
<div class="max-w-3xl mx-auto space-y-6" x-data="announcementShow()">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div class="p-6 space-y-3 text-sm">
            <div class="flex justify-between"><span class="text-slate-500">Target</span><span class="font-medium text-slate-900 capitalize">{{ $announcement->target === 'all' ? 'Teachers & Pupils' : ($announcement->target === 'students' ? 'Pupils' : $announcement->target) }}</span></div>
