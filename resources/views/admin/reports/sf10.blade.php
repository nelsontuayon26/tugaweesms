    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 4px;">
        <tr>
            <td style="width: 60px; text-align: center; vertical-align: middle; border: none; padding: 0;">
                ...
                <img src="{{ asset('images/edukasyon.jpg') }}" alt="DepEd Logo" style="width: 50px; height: auto;">
            </td>
            ...
            <td style="width: 60px; text-align: center; vertical-align: middle; border: none; padding: 0;">
                <img src="{{ asset('images/logo.png') }}" alt="DepEd" style="width: 55px; height: auto;">
            </td>
        </tr>
    </table>
        ...
        <div class="sf10-section-body">
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 2px;">
                <tr>
                    ...
                    <td style="border: none; padding: 1px 0; border-bottom: 1px solid #000; width: 8%;">{{ strtoupper($user->suffix ?? '') }}</td>
                    ...
                    <div class="scholastic-block">
                                <div class="scholastic-block-header">
                                    <div class="scholastic-block-header-row">
                                        <span>School: <span class="u" style="min-width: 100px;">{{ $schoolName }}</span></span>
                                        <span>School ID: <span class="u" style="min-width: 50px;">{{ $schoolId }}</span></span>
                                    </div>
                                    <div class="scholastic-block-header-row">
                                        <span>District: <span class="u" style="min-width: 60px;">{{ $schoolDistrict }}</span></span>
                                        <span>Division: <span class="u" style="min-width: 80px;">{{ $schoolDivision }}</span></span>
                                        <span>Region: <span class="u" style="min-width: 40px;">{{ $schoolRegion }}</span></span>
                                    </div>
                                    <div class="scholastic-block-header-row">
                                        <span>Classified as Grade: <span class="u" style="min-width: 25px;">K</span></span>
                                        <span>Section: <span class="u" style="min-width: 60px;">{{ $currentSection?->name ?? '' }}</span></span>
                                        <span>School Year: <span class="u" style="min-width: 60px;">{{ $activeSchoolYear?->name ?? '' }}</span></span>
                                    </div>
                                    <div class="scholastic-block-header-row">
                                                ...
                                                @foreach($domainData['indicators'] as $indicatorKey => $indicatorText)
                                                    <tr>
                                                        <td class="text-left" style="font-size: 6.5pt; padding-left: 10px;">
                                                            {{ $indicatorText['english'] ?? ($indicatorText['cebuano'] ?? $indicatorKey) }}
                                                        </td>
                    ...
                    @foreach($academicRecords as $schoolYearId => $yearGrades)
                        ...
                        <div class="scholastic-block">
                                            <div class="scholastic-block-header">
                                                ...
                                                <div class="scholastic-block-header-row">
                                                    <span>Classified as Grade: <span class="u" style="min-width: 25px;">{{ str_replace(['Grade ', 'Kindergarten'], ['', 'K'], $gradeLevelName) }}</span></span>
                                                    <span>Section: <span class="u" style="min-width: 60px;">{{ $sectionName }}</span></span>
                                                    <span>School Year: <span class="u" style="min-width: 60px;">{{ $schoolYearName }}</span></span>
                                                </div>
                                                <div class="scholastic-block-header-row">
                                                    <span>Name of Adviser/Teacher: <span class="u" style="min-width: 120px;"></span></span>
                                                    <span>Signature: <span class="u" style="min-width: 80px;"></span></span>
                                            ...
                                            <table class="grades-table">
                                                ...
                                                <tbody>
                                                    @forelse($subjectGroups as $subjectName => $subjectGrades)
                                                        ...
                                                        @endphp
                                                        <tr>
                                                            <td class="text-left" style="font-size: 6.5pt; padding-left: 4px;">{{ $subjectName }}</td>
                                                            <td>{{ $q1 ?? '' }}</td>
                                                            <td>{{ $q2 ?? '' }}</td>
                                                            <td>{{ $q3 ?? '' }}</td>
                                                            <td>{{ $q4 ?? '' }}</td>
