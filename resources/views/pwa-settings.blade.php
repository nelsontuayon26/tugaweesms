...
<body class="{{ $bodyBg ?? 'bg-slate-50' }} text-slate-800 antialiased"
      @if($isStudent)
...
{{-- Mobile Overlay (Admin/Teacher/Student only) --}}
@if($useAlpineSidebar)
...
{{-- Main Content --}}
<div class="min-h-screen {{ $mainClass ?? 'lg:ml-72' }} transition-all duration-300">
