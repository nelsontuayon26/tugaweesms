                    ...
                    <div id="sf1" class="tab-content active">
                        ...
                        <div class="animate-fade-in">
                                ...
                                <div class="form-section-body space-y-4">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" value="<?php echo e(ucfirst($pupilType)); ?>" readonly class="form-input bg-slate-100 text-slate-600 font-semibold">
                                        </div>
                                        <div>
                                            <label class="form-label">Status</label>
                                            <input type="text" value="<?php echo e(ucfirst($status)); ?>" readonly class="form-input bg-slate-100 text-slate-600 font-semibold">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-dashed border-slate-300">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="radio" class="custom-radio" <?php echo e($student->has_lrn ? 'checked' : ''); ?> disabled>
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="radio" class="custom-radio" <?php echo e($student->is_returning_balik_aral ? 'checked' : ''); ?> disabled>
                                                <span class="text-sm text-slate-600">Yes</span>
                                            </label>
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="radio" class="custom-radio" <?php echo e(!$student->is_returning_balik_aral ? 'checked' : ''); ?> disabled>
                                ...
                                <div class="form-section-body space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" value="<?php echo e($student->psa_birth_cert_no ?? 'N/A'); ?>" readonly class="form-input bg-slate-100 text-slate-600">
                                        </div>
                                        ...
                                        <div class="flex items-start gap-4">
                                            <div class="flex-1">
                                                ...
                                                <div class="flex gap-4 mt-1">
                                                    <label class="flex items-center gap-2 cursor-pointer">
                                                        <input type="radio" class="custom-radio" <?php echo e($student->is_ip ? 'checked' : ''); ?> disabled>
                                                        <span class="text-sm text-slate-600">Yes</span>
                                                    </label>
                                                    <label class="flex items-center gap-2 cursor-pointer">
                                                        <input type="radio" class="custom-radio" <?php echo e(!$student->is_ip ? 'checked' : ''); ?> disabled>
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <input type="text" value="<?php echo e($student->ip_specification ?? 'N/A'); ?>" readonly class="form-input bg-slate-100 text-slate-600">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sub-section">
                                        <div class="flex items-start gap-4">
                                            <div class="flex-1">
                                                ...
                                                <div class="flex gap-4 mt-1">
                                                    <label class="flex items-center gap-2 cursor-pointer">
                                                        <input type="radio" class="custom-radio" <?php echo e($student->is_4ps_beneficiary ? 'checked' : ''); ?> disabled>
                                                        <span class="text-sm text-slate-600">Yes</span>
                                                    </label>
                                                    <label class="flex items-center gap-2 cursor-pointer">
                                                        <input type="radio" class="custom-radio" <?php echo e(!$student->is_4ps_beneficiary ? 'checked' : ''); ?> disabled>
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <input type="text" value="<?php echo e($student->household_id_4ps ?? 'N/A'); ?>" readonly class="form-input bg-slate-100 text-slate-600 font-mono tracking-wider">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- ========== SECTION 6: FOR RETURNING/TRANSFEREE ========== -->
                             <?php if($student->is_returning_balik_aral || $pupilType === 'transferee'): ?>
                            <div>
                                <div class="form-section-header">
                                    For Returning Learner (Balik-Aral) and Those Who will Transfer/Move In
                                    <span class="ml-2 px-2 py-0.5 bg-orange-500 text-white text-xs rounded-full"><?php echo e($pupilType === 'transferee' ? 'Transferee' : 'Balik-Aral'); ?></span>
                                </div>
                                <div class="form-section-body space-y-3">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        <div>
                                            <label class="form-label">Last Grade Level Completed</label>
                                            <input type="text" value="<?php echo e($student->last_grade_level_completed ?? 'N/A'); ?>" readonly class="form-input bg-slate-100 text-slate-600">
                                        </div>
                                        <div>
                                            <label class="form-label">Last School Year Completed</label>
                                            <input type="text" value="<?php echo e($student->last_school_year_completed ?? 'N/A'); ?>" readonly class="form-input bg-slate-100 text-slate-600">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        <div>
                                            <label class="form-label">Last School Attended</label>
                                            <input type="text" value="<?php echo e($student->previous_school ?? 'N/A'); ?>" readonly class="form-input bg-slate-100 text-slate-600">
                                        </div>
                                        <div>
                                            <label class="form-label">School ID</label>
                                            <input type="text" value="<?php echo e($student->previous_school_id ?? 'N/A'); ?>" readonly class="form-input bg-slate-100 text-slate-600 font-mono">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-section-body">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        <div>
                                            ...
                                            <input type="text" value="<?php echo e($student->remarks ? match($student->remarks) {
