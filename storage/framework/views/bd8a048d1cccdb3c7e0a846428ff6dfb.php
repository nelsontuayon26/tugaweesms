                ...
                <div class="student-info-card animate-fade-in-up">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div class="student-info-item">
                            ...
                            <span class="student-info-value"><?php echo e($student->user->first_name); ?> <?php echo e($student->user->last_name); ?></span>
                        </div>
                        <div class="student-info-item">
                            <span class="student-info-label">Email:</span>
                            <span class="student-info-value"><?php echo e($student->user->email); ?></span>
                        </div>
                        <div class="student-info-item">
                            <span class="student-info-label">Username:</span>
                            <span class="student-info-value"><?php echo e($student->user->username ?? 'Not set'); ?></span>
                        </div>
                        <!-- Birthdate from students table -->
                        <div class="student-info-item">
                            <span class="student-info-label">Birthdate:</span>
                            <span class="student-info-value"><?php echo e($student->birthdate ? $student->birthdate->format('M d, Y') : 'Not set'); ?></span>
                        </div>
                    </div>
                </div>

               <form action="<?php echo e(route('admin.students.update', $student->id)); ?>" method="POST" enctype="multipart/form-data" class="glass-card p-8 animate-fade-in-up" id="studentForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="first_name" class="form-input input-with-icon" placeholder="First name" required value="<?php echo e(old('first_name', $student->user->first_name)); ?>">
                                </div>
...
<div>
    ...
    <div class="input-group">
        ...
        <input type="text" 
               ...
               value="<?php echo e(old('middle_name', $student->user->middle_name)); ?>">
    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    <i class="fas fa-user input-icon"></i>
                                    <input type="text" name="last_name" class="form-input input-with-icon" placeholder="Last name" required value="<?php echo e(old('last_name', $student->user->last_name)); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-input input-with-icon" placeholder="Username" required value="<?php echo e(old('username', $student->user->username)); ?>">
                                </div>
                                ...
                                <div class="tooltip-container">
                                    <div class="input-group">
                                        ...
                                        <input 
                                            ...
                                            value="<?php echo e($student->user->email); ?>"
                                            disabled
                                            readonly
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input 
                                        ...
                                        pattern="[0-9]{6}"
                                        inputmode="numeric"
                                        value="<?php echo e(old('lrn_suffix', $student->lrn ? substr($student->lrn, 6) : '')); ?>"
                                    >
                                </div>
                                <p class="input-hint">Enter last 6 digits only (12 digits total)</p>
                                <?php $__errorArgs = ['lrn_suffix'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input 
                                        ...
                                        value="<?php echo e(old('birthday', $student->birthdate ? $student->birthdate->format('Y-m-d') : '')); ?>"
                                        required
                                    >
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="birth_place" class="form-input input-with-icon" placeholder="City, Province" value="<?php echo e(old('birth_place', $student->birth_place)); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nationality" class="form-input input-with-icon" placeholder="e.g., Filipino" value="<?php echo e(old('nationality', $student->nationality)); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="religion" class="form-input input-with-icon" placeholder="e.g., Roman Catholic" value="<?php echo e(old('religion', $student->religion)); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="ethnicity" class="form-input input-with-icon" placeholder="e.g., Tagalog, Cebuano, Ilocano" value="<?php echo e(old('ethnicity', $student->ethnicity)); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="mother_tongue" class="form-input input-with-icon" placeholder="e.g., Tagalog, Cebuano, English" value="<?php echo e(old('mother_tongue', $student->mother_tongue)); ?>" required>
                                </div>
                            ...
                            <div>
                                ...
                                <select name="remarks" class="form-select">
                                    ...
                                    <?php $__currentLoopData = \App\Models\Student::$remarksLegend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($code); ?>" <?php echo e(old('remarks', $student->remarks) == $code ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="type" id="studentType" class="form-select" required onchange="togglePreviousSchool()">
                                    ...
                                    <option value="new" <?php echo e(old('type', $activeEnrollment?->type) == 'new' ? 'selected' : ''); ?>>New Student</option>
                                    <option value="continuing" <?php echo e(old('type', $activeEnrollment?->type) == 'continuing' ? 'selected' : ''); ?>>Continuing Student</option>
                                    <option value="transferee" <?php echo e(old('type', $activeEnrollment?->type) == 'transferee' ? 'selected' : ''); ?>>Transferee</option>
                                </select>
                            ...
                            <div id="previousSchoolContainer" class="hidden">
                                ...
                                <div class="input-group">
                                    ...
                                    <input 
                                        ...
                                        value="<?php echo e(old('previous_school', $activeEnrollment?->previous_school ?? '')); ?>"
                                    >
                                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <script>
                        ...
                        const allSections = <?php echo json_encode($sections->map(fn($s) => ['id' => $s->id, 'name' => $s->name, 'grade_level_id' => $s->grade_level_id])) ?>;
...
<div class="form-section">
    ...
    <div class="flex items-center gap-6">
        ...
        <div class="relative">
            ...
            <button type="button" id="removePhoto" class="absolute -top-2 -right-2 w-8 h-8 bg-red-500 text-white rounded-full shadow-md <?php echo e($student->user->photo ? '' : 'hidden'); ?> hover:bg-red-600 transition-colors">            </button>
        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="father_name" class="form-input" placeholder="Full name" value="<?php echo e(old('father_name', $student->father_name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="father_occupation" class="form-input" placeholder="e.g., Farmer, Teacher, OFW" value="<?php echo e(old('father_occupation', $student->father_occupation)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="mother_name" class="form-input" placeholder="Full name" value="<?php echo e(old('mother_name', $student->mother_name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="mother_occupation" class="form-input" placeholder="e.g., Housewife, Teacher, OFW" value="<?php echo e(old('mother_occupation', $student->mother_occupation)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="guardian_name" class="form-input" placeholder="Full name" value="<?php echo e(old('guardian_name', $student->guardian_name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="guardian_relationship" class="form-input" placeholder="e.g., Grandmother, Uncle" value="<?php echo e(old('guardian_relationship', $student->guardian_relationship)); ?>">
                                <?php $__errorArgs = ['guardian_relationship'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input 
                                        ...
                                        pattern="[0-9]{11}"
                                        inputmode="numeric"
                                        value="<?php echo e(old('guardian_contact', $student->guardian_contact)); ?>"
                                    >
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="street_address" class="form-input input-with-icon" placeholder="House number, Street name" value="<?php echo e(old('street_address', $student->street_address)); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="barangay" class="form-input" placeholder="Barangay name" value="<?php echo e(old('barangay', $student->barangay)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="city" class="form-input" placeholder="City name" value="<?php echo e(old('city', $student->city)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="province" class="form-input" placeholder="Province name" value="<?php echo e(old('province', $student->province)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="zip_code" class="form-input input-with-icon" placeholder="4-digit code" value="<?php echo e(old('zip_code', $student->zip_code)); ?>">
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <?php if($student->birth_certificate_path): ?>
                                    <p class="text-xs text-teal-600 mt-1"><a href="<?php echo e(asset('storage/' . $student->birth_certificate_path)); ?>" target="_blank" class="underline">View existing file</a></p>
                                <?php endif; ?>
                            </div>
                            <div>
                                ...
                                <?php if($student->report_card_path): ?>
                                    <p class="text-xs text-teal-600 mt-1"><a href="<?php echo e(asset('storage/' . $student->report_card_path)); ?>" target="_blank" class="underline">View existing file</a></p>
                                <?php endif; ?>
                            </div>
                            <div>
                                ...
                                <?php if($student->good_moral_path): ?>
                                    <p class="text-xs text-teal-600 mt-1"><a href="<?php echo e(asset('storage/' . $student->good_moral_path)); ?>" target="_blank" class="underline">View existing file</a></p>
                                <?php endif; ?>
                            </div>
                            <div>
                                ...
                                <?php if($student->transfer_credential_path): ?>
                                    <p class="text-xs text-teal-600 mt-1"><a href="<?php echo e(asset('storage/' . $student->transfer_credential_path)); ?>" target="_blank" class="underline">View existing file</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<div class="floating-actions">
    ...
    <a href="<?php echo e(route('admin.students.show', $student->id)); ?>" class="btn-back-colored" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); box-shadow: 0 4px 15px rgba(16, 185, 129, 0.4);" title="View Details">
        <i class="fas fa-eye"></i>
    </a>
    <!-- Back Button (Blue) -->
    <a href="<?php echo e(route('admin.students.index')); ?>" class="btn-back-colored" title="Back to List">
...
<div id="userData" 
     data-photo="<?php echo e($student->user->photo ?? ''); ?>" 
     data-name="<?php echo e($student->user->first_name ?? ''); ?> <?php echo e($student->user->last_name ?? ''); ?>" 
     style="display: none;">
</div>
