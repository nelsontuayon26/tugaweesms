...
<div class="overflow-x-auto pb-4">
        ...
        <tbody>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $maleData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="nutritional-<?php echo e(strtolower(str_replace(' ', '-', $data['nutritional_status']))); ?> text-[8px]"><?php echo e($data['nutritional_status'] ?? 'Not Assessed'); ?></td>
                    <td class="hfa-<?php echo e(strtolower(str_replace(' ', '-', $data['height_for_age']))); ?> text-[8px]"><?php echo e($data['height_for_age'] ?? 'Not Assessed'); ?></td>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <table class="sf8-table">
            ...
            <tbody>
                <tr class="nutritional-severely-wasted"><td class="text-left pl-2 font-bold text-[8px]">Severely Wasted</td><td><?php echo e($summaryStats['male_severely_wasted'] > 0 ? $summaryStats['male_severely_wasted'] : ''); ?></td><td><?php echo e($summaryStats['female_severely_wasted'] > 0 ? $summaryStats['female_severely_wasted'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_severely_wasted'] + $summaryStats['female_severely_wasted']) > 0 ? ($summaryStats['male_severely_wasted'] + $summaryStats['female_severely_wasted']) : ''); ?></td></tr>
                <tr class="nutritional-wasted"><td class="text-left pl-2 font-bold text-[8px]">Wasted</td><td><?php echo e($summaryStats['male_wasted'] > 0 ? $summaryStats['male_wasted'] : ''); ?></td><td><?php echo e($summaryStats['female_wasted'] > 0 ? $summaryStats['female_wasted'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_wasted'] + $summaryStats['female_wasted']) > 0 ? ($summaryStats['male_wasted'] + $summaryStats['female_wasted']) : ''); ?></td></tr>
                <tr class="nutritional-normal"><td class="text-left pl-2 font-bold text-[8px]">Normal</td><td><?php echo e($summaryStats['male_normal'] > 0 ? $summaryStats['male_normal'] : ''); ?></td><td><?php echo e($summaryStats['female_normal'] > 0 ? $summaryStats['female_normal'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_normal'] + $summaryStats['female_normal']) > 0 ? ($summaryStats['male_normal'] + $summaryStats['female_normal']) : ''); ?></td></tr>
                <tr class="nutritional-overweight"><td class="text-left pl-2 font-bold text-[8px]">Overweight</td><td><?php echo e($summaryStats['male_overweight'] > 0 ? $summaryStats['male_overweight'] : ''); ?></td><td><?php echo e($summaryStats['female_overweight'] > 0 ? $summaryStats['female_overweight'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_overweight'] + $summaryStats['female_overweight']) > 0 ? ($summaryStats['male_overweight'] + $summaryStats['female_overweight']) : ''); ?></td></tr>
                <tr class="nutritional-obese"><td class="text-left pl-2 font-bold text-[8px]">Obese</td><td><?php echo e($summaryStats['male_obese'] > 0 ? $summaryStats['male_obese'] : ''); ?></td><td><?php echo e($summaryStats['female_obese'] > 0 ? $summaryStats['female_obese'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_obese'] + $summaryStats['female_obese']) > 0 ? ($summaryStats['male_obese'] + $summaryStats['female_obese']) : ''); ?></td></tr>
            </tbody>
        </table>
        ...
        <table class="sf8-table">
            ...
            <tbody>
                <tr class="hfa-severely-stunted"><td class="text-left pl-2 font-bold text-[8px]">Severely Stunted</td><td><?php echo e($summaryStats['male_severely_stunted'] > 0 ? $summaryStats['male_severely_stunted'] : ''); ?></td><td><?php echo e($summaryStats['female_severely_stunted'] > 0 ? $summaryStats['female_severely_stunted'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_severely_stunted'] + $summaryStats['female_severely_stunted']) > 0 ? ($summaryStats['male_severely_stunted'] + $summaryStats['female_severely_stunted']) : ''); ?></td></tr>
                <tr class="hfa-stunted"><td class="text-left pl-2 font-bold text-[8px]">Stunted</td><td><?php echo e($summaryStats['male_stunted'] > 0 ? $summaryStats['male_stunted'] : ''); ?></td><td><?php echo e($summaryStats['female_stunted'] > 0 ? $summaryStats['female_stunted'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_stunted'] + $summaryStats['female_stunted']) > 0 ? ($summaryStats['male_stunted'] + $summaryStats['female_stunted']) : ''); ?></td></tr>
                <tr class="hfa-normal"><td class="text-left pl-2 font-bold text-[8px]">Normal</td><td><?php echo e($summaryStats['male_normal_hfa'] > 0 ? $summaryStats['male_normal_hfa'] : ''); ?></td><td><?php echo e($summaryStats['female_normal_hfa'] > 0 ? $summaryStats['female_normal_hfa'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_normal_hfa'] + $summaryStats['female_normal_hfa']) > 0 ? ($summaryStats['male_normal_hfa'] + $summaryStats['female_normal_hfa']) : ''); ?></td></tr>
                <tr class="hfa-tall"><td class="text-left pl-2 font-bold text-[8px]">Tall</td><td><?php echo e($summaryStats['male_tall'] > 0 ? $summaryStats['male_tall'] : ''); ?></td><td><?php echo e($summaryStats['female_tall'] > 0 ? $summaryStats['female_tall'] : ''); ?></td><td class="font-bold"><?php echo e(($summaryStats['male_tall'] + $summaryStats['female_tall']) > 0 ? ($summaryStats['male_tall'] + $summaryStats['female_tall']) : ''); ?></td></tr>
            </tbody>
        </table>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\reports\sf8.blade.php ENDPATH**/ ?>