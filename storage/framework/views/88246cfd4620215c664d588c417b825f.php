                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex gap-2">
                                        ...
                                        <form action="<?php echo e(route('admin.sections.destroy', $section)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this section?');" class="inline">
                                            <?php echo csrf_field(); ?>
