...
<?php $__env->startSection('header-title', 'Edit Event'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-5">
                ...
                <input type="date" name="date" id="date" value="<?php echo e(old('date', $event->date->format('Y-m-d'))); ?>" required
                       class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="5"
                          ...
                          placeholder="Enter event details, schedule, location, etc..."><?php echo e(old('description', $event->description)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\events\edit.blade.php ENDPATH**/ ?>