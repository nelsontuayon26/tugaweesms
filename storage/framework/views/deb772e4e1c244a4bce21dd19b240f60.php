    ...
    <main class="min-h-[100dvh] transition-all duration-300 flex flex-col lg:ml-72">
        ...
        <header class="sticky top-0 z-20 bg-white border-b border-slate-200">
            <div class="flex items-center h-14 px-4 lg:px-6">
                ...
                <form action="<?php echo e(route('student.messages.destroy', $message)); ?>" method="POST" onsubmit="return confirm('Delete this conversation?')" class="ml-2">
                    <?php echo csrf_field(); ?>
                ...
                <?php if($message->attachments->count() > 0): ?>
                    <div class="mt-2 space-y-1 <?php echo e($message->sender_id === auth()->id() ? 'text-right' : 'text-left'); ?>">
                        <?php $__currentLoopData = $message->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('student.messages.attachment', $attachment)); ?>" 
            ...
            <?php $__currentLoopData = $message->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="animate-fade-in <?php echo e($reply->sender_id === auth()->id() ? 'text-right' : 'text-left'); ?>" style="animation-delay: <?php echo e($loop->index * 0.05); ?>s">
                    ...
                    <?php if($reply->attachments->count() > 0): ?>
                        <div class="mt-1 <?php echo e($reply->sender_id === auth()->id() ? 'text-right' : ''); ?>">
        ...
        <div class="bg-white border-t border-slate-200 p-4">
            <form action="<?php echo e(route('student.messages.reply', $message)); ?>" method="POST" enctype="multipart/form-data" class="flex items-end gap-2">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\student\messages\show.blade.php ENDPATH**/ ?>