    ...
    <div class="flex-1 lg:ml-72 h-screen flex flex-col bg-slate-50 overflow-hidden">
        ...
        <div class="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shrink-0">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-0.5">Create and broadcast an announcement to your pupils</p>
            </div>
        ...
        <div class="flex-1 overflow-y-auto p-6">
            <div class="max-w-3xl mx-auto">
                <form action="<?php echo e(route('teacher.announcements.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" @submit="return validateForm()">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\announcements\create.blade.php ENDPATH**/ ?>