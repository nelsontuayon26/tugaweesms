<?php $__env->startSection('title', 'Report Cards - ' . $section->name); ?>
...
<div class="container mx-auto px-4 py-6" x-data="reportCards()">
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="text-gray-600"><?php echo e($section->name); ?> - <?php echo e($section->gradeLevel->name ?? ''); ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($students->count()); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($students->where('average_grade', '>', 0)->count()); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e(round($students->avg('attendance_rate'), 1)); ?>%</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e(round($students->avg('average_grade'), 1)); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr x-show="matchesSearch('<?php echo e(strtolower($student->user->name)); ?>')">
                        <td class="px-6 py-4">
                            <input type="checkbox" 
                            ...
                            <div class="flex items-center">
                                <div class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center">
                                    <span class="text-sm font-medium text-indigo-600">
                                        <?php echo e(strtoupper(substr($student->user->first_name, 0, 1) . substr($student->user->last_name, 0, 1))); ?>
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500">LRN: <?php echo e($student->lrn ?? 'N/A'); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <?php if($student->average_grade > 0): ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php echo e($student->average_grade >= 75 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <?php echo e(number_format($student->average_grade, 2)); ?>
                        ...
                        <td class="px-6 py-4 text-center">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                <?php echo e($student->attendance_rate >= 80 ? 'bg-green-100 text-green-800' : ($student->attendance_rate >= 60 ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
                                <?php echo e($student->attendance_rate); ?>%
                            </span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <?php if($student->coreValues && $student->coreValues->count() > 0): ?>
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium">
                            <a href="<?php echo e(route('teacher.report-cards.preview', [$section, $student])); ?>" 
                               target="_blank"
                               class="text-indigo-600 hover:text-indigo-900 mr-3">Preview</a>
                            <button @click="generateSingle(<?php echo e($student->id); ?>)" 
    ...
    function reportCards() {
        return {
            ...
            toggleSelectAll(checked) {
                if (checked) {
                    this.selectedStudents = <?php echo json_encode($students->pluck('id'), 15, 512) ?>;
                } else {
            ...
            async generateSingle(studentId) {
                ...
                form.method = 'POST';
                form.action = `<?php echo e(route('teacher.report-cards.generate', [$section, '__STUDENT__'])); ?>`.replace('__STUDENT__', studentId);
            ...
            async generateBatch() {
                ...
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = "<?php echo e(route('teacher.report-cards.batch', $section)); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\report-cards\index.blade.php ENDPATH**/ ?>