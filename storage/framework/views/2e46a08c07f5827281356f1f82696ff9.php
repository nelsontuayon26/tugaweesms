        ...
        <div class="main-wrapper">
            <div class="main-content">
               <div class="max-w-6xl mx-auto pb-32">
                    ...
                    <form action="<?php echo e(route('admin.sections.store')); ?>" method="POST" class="space-y-6" id="sectionForm">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="grade_level_id" required class="form-select" id="gradeLevel">
                                            ...
                                            <?php $__currentLoopData = $gradeLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($grade->id); ?>" <?php echo e(old('grade_level_id') == $grade->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="school_year_id" class="form-select" id="schoolYear">
                                            ...
                                            <?php $__currentLoopData = $schoolYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($year->id); ?>" 
                                                    <?php echo e(old('school_year_id', $activeSchoolYear?->id) == $year->id ? 'selected' : ''); ?>

                                                    <?php echo e($year->is_active ? 'data-active="true"' : ''); ?>>
                                        ...
                                        <p class="input-hint" id="schoolYearHint">
                                            ...
                                            <span class="<?php echo e($activeSchoolYear ? 'valid' : ''); ?>">
                                                <?php echo e($activeSchoolYear ? 'Default: ' . $activeSchoolYear->name : 'No active school year set'); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('teacher_id') == $teacher->id ? 'selected' : ''); ?>>
            ...
            <?php if($teacher->sections->count()): ?>
                (<?php echo e($teacher->sections->count()); ?> section<?php echo e($teacher->sections->count() > 1 ? 's' : ''); ?>)
            <?php endif; ?>
        </option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="capacity" 
                                           value="<?php echo e(old('capacity', 40)); ?>"
                                           class="form-input" 
                                           placeholder="40"
                                           min="1"
                                           max="60"
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\sections\create.blade.php ENDPATH**/ ?>