...
<body class="bg-slate-100 min-h-screen" x-data="{ mobileOpen: false }" @keydown.escape.window="mobileOpen = false">
    ...
    <div class="lg:ml-72 p-6">
        ...
        <div class="no-print mb-4 bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <form method="GET" action="<?php echo e(route('teacher.sf1')); ?>" class="flex items-end gap-4">
                <div class="flex-1">
        ...
        <div class="sf1-container bg-white p-4 rounded-xl shadow-lg border border-slate-200 max-w-[1400px] mx-auto">
                ...
                <thead>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $maleEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="text-left uppercase text-[8px] data-cell" title="<?php echo e($lastName); ?>"><?php echo e($lastName); ?></td>
                            <td class="text-left uppercase text-[8px] data-cell" title="<?php echo e($firstName); ?>"><?php echo e($firstName); ?></td>
                            <td class="text-left uppercase text-[8px] data-cell" title="<?php echo e($middleName); ?>"><?php echo e($middleName); ?></td>
                            ...
                            <td class="text-center text-[8px]">
                                <?php if($student->birthdate): ?>
                                    <?php echo e(\Carbon\Carbon::parse($student->birthdate)->format('m/d/Y')); ?>
                            ...
                            <td class="text-left uppercase text-[7px] data-cell" title="<?php echo e($houseStreet); ?>"><?php echo e($houseStreet); ?></td>
                            <td class="text-left uppercase text-[7px] data-cell" title="<?php echo e($barangay); ?>"><?php echo e($barangay); ?></td>
                            <td class="text-left uppercase text-[7px] data-cell" title="<?php echo e($municipality); ?>"><?php echo e($municipality); ?></td>
                            <td class="text-left uppercase text-[7px] data-cell" title="<?php echo e($province); ?>"><?php echo e($province); ?></td>
                            <td class="text-left uppercase text-[7px] data-cell" title="<?php echo e($fatherName); ?>"><?php echo e($fatherName); ?></td>
                            <td class="text-left uppercase text-[7px] data-cell" title="<?php echo e($motherName); ?>"><?php echo e($motherName); ?></td>
                            <td class="text-left uppercase text-[7px] data-cell" title="<?php echo e($guardianName); ?>"><?php echo e($guardianName); ?></td>
                    ...
                    <?php for($i = $totalStudents; $i < $totalRows; $i++): ?>
                        <tr style="height: 18px;">
                            ...
                            <?php for($j = 0; $j < 20; $j++): ?><td></td><?php endfor; ?>
                        </tr>
                    <?php endfor; ?>
                </tbody>
            </table>
            ...
            <div class="mt-3 grid grid-cols-3 gap-3 text-xs border-t-2 border-black pt-3">
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <span class="border-b-2 border-black w-14 text-center font-bold text-sm"><?php echo e($maleCount); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="font-semibold text-[10px]">FEMALE:</span>
                        <span class="border-b-2 border-black w-14 text-center font-bold text-sm"><?php echo e($femaleCount); ?></span>
                    </div>
                </div>
                <div class="text-center">
                    <div class="flex items-center justify-center gap-2 mb-1">
                        <span class="font-semibold text-[10px]">TOTAL:</span>
                        <span class="border-b-2 border-black w-20 text-center font-bold text-lg"><?php echo e($maleCount + $femaleCount); ?></span>
                    </div>
                </div>
            ...
            <div class="mt-4 pt-2 border-t border-slate-300 text-[9px] text-slate-500 flex justify-between">
                ...
                <span>Date Generated: <?php echo e(now()->format('F d, Y h:i A')); ?></span>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4 text-sm">
                <div class="space-y-2">
                    <div class="flex justify-between border-b border-slate-100 pb-1">
                        ...
                        <span class="font-mono font-medium"><?php echo e($schoolId); ?></span>
                    </div>
                    <div class="flex justify-between border-b border-slate-100 pb-1">
                        <span class="text-slate-500">School Name:</span>
                        <span class="font-medium"><?php echo e($schoolName); ?></span>
                    </div>
                </div>
                <div class="space-y-2">
                    <div class="flex justify-between border-b border-slate-100 pb-1">
                        <span class="text-slate-500">Division:</span>
                        <span><?php echo e($schoolDivision); ?></span>
                    </div>
                    <div class="flex justify-between border-b border-slate-100 pb-1">
                        <span class="text-slate-500">Region:</span>
                        <span><?php echo e($schoolRegion); ?></span>
                    </div>
                </div>
                <div class="space-y-2">
                    <div class="flex justify-between border-b border-slate-100 pb-1">
                        <span class="text-slate-500">School Head:</span>
                        <span class="font-medium"><?php echo e($schoolHead); ?></span>
                    </div>
                    <div class="flex justify-between border-b border-slate-100 pb-1">
                        <span class="text-slate-500">Active School Year:</span>
                        <span class="text-indigo-600 font-medium"><?php echo e($schoolYear); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\school-forms\sf1.blade.php ENDPATH**/ ?>