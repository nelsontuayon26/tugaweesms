    ...
    <div class="flex gap-4">
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-200 font-bold border-t-2 border-black">
                        ...
                        <td class="text-center text-[9px] border-b-2 border-black">
                            <?php $allGrades = array_merge($maleGrades, $femaleGrades); ?>
                            <?php echo e(count($allGrades) > 0 ? round(array_sum($allGrades) / count($allGrades), 0) : ''); ?>

                        </td>
                        <td colspan="2" class="border-b-2 border-black"></td>
                    </tr>
                    <?php $totalStudents = $maleCounter + $femaleCounter; $totalRows = max(30, $totalStudents + 5); ?>
        ...
        <div class="w-64">
            <table class="summary-table">
                ...
                <tbody>
                    <tr><td class="text-left text-[8px] pl-2">PROMOTED</td><td class="font-bold text-[9px]"><?php echo e($malePromoted > 0 ? $malePromoted : ''); ?></td><td class="font-bold text-[9px]"><?php echo e($femalePromoted > 0 ? $femalePromoted : ''); ?></td><td class="font-bold text-[9px]"><?php echo e(($malePromoted + $femalePromoted) > 0 ? ($malePromoted + $femalePromoted) : ''); ?></td></tr>
                    <tr><td class="text-left text-[8px] pl-2">*CONDITIONAL</td><td class="font-bold text-[9px]"><?php echo e($maleConditional > 0 ? $maleConditional : ''); ?></td><td class="font-bold text-[9px]"><?php echo e($femaleConditional > 0 ? $femaleConditional : ''); ?></td><td class="font-bold text-[9px]"><?php echo e(($maleConditional + $femaleConditional) > 0 ? ($maleConditional + $femaleConditional) : ''); ?></td></tr>
                    <tr><td class="text-left text-[8px] pl-2">RETAINED</td><td class="font-bold text-[9px]"><?php echo e($maleRetained > 0 ? $maleRetained : ''); ?></td><td class="font-bold text-[9px]"><?php echo e($femaleRetained > 0 ? $femaleRetained : ''); ?></td><td class="font-bold text-[9px]"><?php echo e(($maleRetained + $femaleRetained) > 0 ? ($maleRetained + $femaleRetained) : ''); ?></td></tr>
                    <tr class="bg-gray-100 font-bold"><td class="text-left text-[8px] pl-2">TOTAL</td><td class="text-[9px]"><?php echo e($maleCounter > 0 ? $maleCounter : ''); ?></td><td class="text-[9px]"><?php echo e($femaleCounter > 0 ? $femaleCounter : ''); ?></td><td class="text-[9px]"><?php echo e($totalStudents > 0 ? $totalStudents : ''); ?></td></tr>
                </tbody>
            </table>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\reports\sf5.blade.php ENDPATH**/ ?>