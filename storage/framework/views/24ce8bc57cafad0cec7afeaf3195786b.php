...
<head>
    ...
    <title>Messenger - <?php echo e($isTeacher ? 'Teacher Portal' : 'Pupil Portal'); ?></title>
                ...
                <div class="flex-1 overflow-y-auto scrollbar-thin">
                    <template x-if="filteredContacts.length === 0">
                        <div class="p-4 text-center">
                            ...
                            <?php if($isTeacher && empty($contacts)): ?>
                        ...
                        <div x-ref="messagesContainer" 
                            ...
                            <template x-if="loadingMessages">
                                <div class="flex items-center justify-center py-8">
                                    <?php if (isset($component)) { $__componentOriginal981cd51f0a31a2c6a62cd57d44cc340e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal981cd51f0a31a2c6a62cd57d44cc340e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.inline-spinner','data' => ['size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('inline-spinner'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal981cd51f0a31a2c6a62cd57d44cc340e)): ?>
<?php $attributes = $__attributesOriginal981cd51f0a31a2c6a62cd57d44cc340e; ?>
<?php unset($__attributesOriginal981cd51f0a31a2c6a62cd57d44cc340e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal981cd51f0a31a2c6a62cd57d44cc340e)): ?>
<?php $component = $__componentOriginal981cd51f0a31a2c6a62cd57d44cc340e; ?>
<?php unset($__componentOriginal981cd51f0a31a2c6a62cd57d44cc340e); ?>
<?php endif; ?>
                                </div>
                            </template>
...
function messenger() {
    return {
        ...
        contacts: <?php echo json_encode($contactsData, 15, 512) ?>,
        sending: false,
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\messenger\index.blade.php ENDPATH**/ ?>