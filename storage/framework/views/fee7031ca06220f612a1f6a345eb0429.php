    ...
    <div class="lg:ml-72 w-full min-h-screen p-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 text-sm text-slate-500 mb-4">
                ...
                <a href="<?php echo e(route('teacher.books.inventory')); ?>" class="hover:text-indigo-600">Inventory</a>
                <i class="fas fa-chevron-right text-xs"></i>
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('teacher.books.inventory')); ?>" class="px-4 py-2 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded-xl font-medium transition-colors">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-xl p-8 max-w-4xl">
            <form method="POST" action="<?php echo e(route('teacher.books.storeInventory')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="subject_area" required
                            ...
                            <?php $__currentLoopData = $subjectAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($subject); ?>" <?php echo e(old('subject_area') == $subject ? 'selected' : ''); ?>>
                                    <?php echo e($subject); ?>
                    ...
                    <div>
                        ...
                        <select name="grade_level" required
                            ...
                            <?php $__currentLoopData = $gradeLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($grade->name); ?>" <?php echo e(old('grade_level') == $grade->name ? 'selected' : ''); ?>>
                                    <?php echo e($grade->name); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <option value="All" <?php echo e(old('grade_level') == 'All' ? 'selected' : ''); ?>>All Grades</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="book_code" value="<?php echo e(old('book_code')); ?>" required
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
                    ...
                    <div>
                        ...
                        <input type="number" name="publication_year" value="<?php echo e(old('publication_year')); ?>" min="1900" max="<?php echo e(date('Y') + 1); ?>"
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
                    ...
                    <div>
                        ...
                        <input type="number" name="total_copies" value="<?php echo e(old('total_copies', 1)); ?>" required min="1" max="1000"
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="replacement_cost" value="<?php echo e(old('replacement_cost')); ?>" step="0.01" min="0"
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
                               placeholder="0.00">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="remarks" rows="3"
                                  ...
                                  placeholder="Additional notes about this book..."><?php echo e(old('remarks')); ?></textarea>
                    </div>
                </div>

                <!-- Submit Buttons -->
                <div class="mt-8 flex justify-end gap-4">
                    <a href="<?php echo e(route('teacher.books.inventory')); ?>" class="px-6 py-3 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded-xl font-medium transition-colors">
                        Cancel
                    </a>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\books\create-inventory.blade.php ENDPATH**/ ?>