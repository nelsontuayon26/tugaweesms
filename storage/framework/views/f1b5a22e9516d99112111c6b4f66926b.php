                ...
                <?php else: ?>
                    <div class="divide-y divide-slate-100">
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-5 hover:bg-slate-50 transition-colors <?php echo e($event->date->isToday() ? 'bg-amber-50/30' : ''); ?>">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex items-center gap-1 shrink-0">
                                        <a href="<?php echo e(route('student.events.show', $event)); ?>" class="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors">
                                            View Details
                                        </a>
                                    </div>
                                </div>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\student\events\index.blade.php ENDPATH**/ ?>