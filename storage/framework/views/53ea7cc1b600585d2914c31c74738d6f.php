                        ...
                        <div class="min-w-0">
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-0.5">
                                <p class="text-xs sm:text-sm text-slate-500 font-medium flex items-center gap-1.5">
                                    ...
                                    <span class="truncate"><?php echo e(now()->format('l, F j, Y')); ?></span>
                                </p>
                                <?php if($activeSchoolYear): ?>
                                    <span class="school-year-badge flex-shrink-0">
                                        <i class="fas fa-graduation-cap text-[10px]"></i>
                                        <span class="truncate max-w-[100px] sm:max-w-none"><?php echo e($activeSchoolYearName); ?></span>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php endif; ?>
            ...
            <main class="main-content">
                ...
                <?php if(!$activeSchoolYear): ?>
                    <div class="mb-4 sm:mb-6 bg-amber-50 border border-amber-200 rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3 animate-fade-in-up">
                        ...
                        <a href="<?php echo e(route('admin.school-years.index')); ?>" class="w-full sm:w-auto px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-medium text-sm transition-colors text-center flex-shrink-0">
                            Manage School Years
                        </a>
                    </div>
                <?php endif; ?>
                ...
                <div class="mb-6 sm:mb-8 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 text-white shadow-xl shadow-blue-500/20 relative overflow-hidden animate-fade-in-up">
                    ...
                    <div class="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div class="min-w-0">
                            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2">Welcome back, <?php echo e(auth()->user()->first_name ?? auth()->user()->name ?? 'Admin'); ?>! 👋</h1>
                            ...
                            <?php if($activeSchoolYear): ?>
                                <p class="text-blue-200 text-xs sm:text-sm mt-2">
                                    ...
                                    Active School Year: <span class="font-semibold text-white"><?php echo e($activeSchoolYearName); ?></span>
                                </p>
                            <?php endif; ?>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div class="lg:col-span-2 glass-card rounded-2xl p-4 sm:p-6 shadow-sm animate-fade-in-up" style="animation-delay: 0.5s;">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-6">
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-slate-500"><?php echo e($weekRangeLabel); ?> • <?php echo e($activeSchoolYearName); ?></p>
                            </div>
                    ...
                    <div class="space-y-4 sm:space-y-6 animate-fade-in-up" style="animation-delay: 0.6s;">
                        <div class="glass-card rounded-2xl p-4 sm:p-6 shadow-sm">
                            ...
                            <p class="text-xs text-slate-500 mb-4"><?php echo e($activeSchoolYearName); ?></p>
                            <div class="space-y-3">
                                <?php
                                ...
                                ?>
                                <?php $__empty_1 = true; $__currentLoopData = $gradeDistribution; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex justify-between items-center mb-1">
                                                <span class="font-semibold text-slate-700 text-sm truncate"><?php echo e($grade); ?></span>
                                                <span class="font-bold text-slate-900 text-sm"><?php echo e($count); ?></span>
                                            </div>
                                            <div class="h-2 bg-slate-100 rounded-full overflow-hidden">
                                                <div class="h-full bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full progress-bar" style="width: <?php echo e(($count / $maxCount) * 100); ?>%"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="glass-card rounded-2xl p-4 sm:p-6 shadow-sm">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="<?php echo e(route('admin.events.index')); ?>" class="text-blue-600 hover:text-blue-700 text-sm font-semibold">View All</a>
                            </div>
                            <div class="space-y-3">
                                <?php
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $upcomingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="flex items-start gap-3 p-2 sm:p-3 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer group">
                                        <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-blue-100 to-blue-50 text-blue-600 flex flex-col items-center justify-center font-bold text-xs border border-blue-200 group-hover:shadow-md transition-all flex-shrink-0">
                                            ...
                                            <span class="text-base sm:text-lg"><?php echo e($event->date->format('d')); ?></span>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <p class="font-semibold text-slate-800 text-sm truncate group-hover:text-blue-600 transition-colors"><?php echo e($event->title); ?></p>
                ...
                <div class="glass-card rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden animate-fade-in-up" style="animation-delay: 0.7s;">
                    <div class="p-4 sm:p-6 border-b border-slate-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-gradient-to-r from-slate-50 to-white">
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-slate-500"><?php echo e($activeSchoolYearName); ?> • Latest student registrations</p>
                        </div>
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <a href="<?php echo e(route('admin.students.index')); ?>" class="bg-blue-50 hover:bg-blue-100 text-blue-700 px-3 py-2 rounded-xl font-semibold text-sm transition-all flex items-center gap-1.5">
                                    ...
                                    <tr class="group hover:bg-slate-50 transition-colors">
                                        <td class="px-4 sm:px-6 py-3 sm:py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <img src="<?php echo e($student->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($student->full_name) . '&background=random&color=fff'); ?>" 
                                                     alt="" 
                                                     class="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white shadow-sm flex-shrink-0">
                                                <div class="min-w-0">
                                                    <p class="font-bold text-slate-900 text-sm group-hover:text-blue-600 transition-colors truncate"><?php echo e($student->full_name); ?></p>
                                                    <p class="text-xs text-slate-500"><?php echo e($student->gender); ?></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-4 sm:px-6 py-3 sm:py-4">
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg bg-slate-100 text-slate-700 font-semibold text-xs sm:text-sm">
                                                <?php echo e($student->grade_level); ?>-<?php echo e($student->section->name ?? 'N/A'); ?>

                                            </span>
                                        </td>
                                        <td class="px-4 sm:px-6 py-3 sm:py-4">
                                            <span class="font-mono text-xs sm:text-sm text-slate-600 bg-slate-50 px-2 py-1 rounded border border-slate-200"><?php echo e($student->lrn ?? 'N/A'); ?></span>
                                        </td>
                                        <td class="px-4 sm:px-6 py-3 sm:py-4">
                                            <span class="status-badge status-<?php echo e($student->status); ?> capitalize">
                                        ...
                                        <td class="px-4 sm:px-6 py-3 sm:py-4 text-right">
                                            <div class="flex items-center justify-end gap-1">
                                                <a href="<?php echo e(route('admin.students.show', $student)); ?>" class="p-1.5 sm:p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="View">
                                                    <i class="fas fa-eye text-sm"></i>
                                                </a>
                                                <a href="<?php echo e(route('admin.students.edit', $student)); ?>" class="p-1.5 sm:p-2 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors" title="Edit">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            ...
                                            <p class="text-slate-400 text-sm mt-1">No recent enrollments for <?php echo e($activeSchoolYearName); ?></p>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                    ...
                    <?php if($recentStudents->count() > 0): ?>
                        <div class="px-4 sm:px-6 py-3 sm:py-4 border-t border-slate-200/80 bg-slate-50/50 flex flex-col sm:flex-row items-center justify-between gap-3">
                            <p class="text-xs sm:text-sm text-slate-500">Showing <span class="font-semibold text-slate-900">1-<?php echo e($recentStudents->count()); ?></span> of <span class="font-semibold text-slate-900"><?php echo e($totalStudentsCount); ?></span> students</p>
                            <div class="flex items-center gap-2">
                                ...
                                <a href="<?php echo e(route('admin.students.index')); ?>" class="px-3 py-1.5 text-xs sm:text-sm font-medium text-slate-600 hover:text-slate-900 hover:bg-white border border-slate-200 rounded-lg transition-all">
                                    Next
                                </a>
                            </div>
                        </div>
    ...
    <div id="quickActionsModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="absolute top-16 sm:top-24 right-4 sm:right-6 bg-white rounded-2xl shadow-2xl p-2 w-72 sm:w-80 animate-fade-in-up border border-slate-200">
            ...
            <div class="p-2 space-y-1">
                <a href="<?php echo e(route('admin.students.create')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-all group">
                ...
                <a href="<?php echo e(route('admin.teachers.create')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-all group">
                ...
                <a href="<?php echo e(route('admin.sections.index')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-all group">
    ...
    (function(){
        ...
        function performSearch(query) {
            ...
            fetch(`<?php echo e(route('admin.search')); ?>?q=` + encodeURIComponent(query))
                .then(r => r.json())
                .then(data => {
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>