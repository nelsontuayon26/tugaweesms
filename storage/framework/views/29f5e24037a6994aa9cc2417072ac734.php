...
<body class="bg-slate-100 min-h-screen" x-data="{ mobileOpen: false }" @keydown.escape.window="mobileOpen = false">
    ...
    <div class="lg:ml-72 p-6">
        ...
        <div class="mb-4 flex items-center justify-between no-print">
            ...
            <div class="flex gap-3">
                <div class="px-4 py-2 rounded-lg bg-indigo-50 border border-indigo-200 text-indigo-700 text-sm font-medium">
                    <i class="fas fa-heartbeat mr-2"></i>SY <?php echo e($activeSchoolYear?->name ?? now()->format('Y')); ?>
        ...
        <div class="no-print mb-4 bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <form method="GET" action="<?php echo e(route('teacher.sf8')); ?>" class="flex items-end gap-4">
                <div class="flex-1">
                ...
                <div class="w-48">
                    ...
                    <select name="period" onchange="this.form.submit()" class="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-indigo-500">
                        <option value="bosy" <?php echo e($selectedPeriod == 'bosy' ? 'selected' : ''); ?>>Beginning of SY (BoSY)</option>
                        <option value="eosy" <?php echo e($selectedPeriod == 'eosy' ? 'selected' : ''); ?>>End of SY (EoSY)</option>
                    </select>
                </div>
        ...
        <?php if($healthData->isEmpty() && $selectedSection): ?>
        ...
        <div class="no-print grid grid-cols-5 gap-3 mb-4">
            ...
            <div class="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
                ...
                <p class="text-2xl font-bold text-emerald-600"><?php echo e($summaryStats['assessed_count']); ?></p>
            </div>
            <div class="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
                <p class="text-xs text-rose-600 uppercase font-semibold">Malnourished</p>
                <p class="text-2xl font-bold text-rose-600">
                    <?php echo e($summaryStats['male_severely_wasted'] + $summaryStats['male_wasted'] + $summaryStats['female_severely_wasted'] + $summaryStats['female_wasted']); ?>
            ...
            <div class="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
                ...
                <p class="text-2xl font-bold text-amber-600">
                    <?php echo e($summaryStats['male_severely_stunted'] + $summaryStats['male_stunted'] + $summaryStats['female_severely_stunted'] + $summaryStats['female_stunted']); ?>
            ...
            <div class="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
                ...
                <p class="text-2xl font-bold text-blue-600">
                    <?php echo e($summaryStats['male_overweight'] + $summaryStats['male_obese'] + $summaryStats['female_overweight'] + $summaryStats['female_obese']); ?>
        ...
        <?php if($healthData->isNotEmpty()): ?>
<div class="overflow-x-auto pb-4">       <div class="sf8-container bg-white p-4 rounded-xl shadow-lg border border-slate-200 max-w-[1600px] mx-auto">
            ...
            <div class="sf8-header mb-0">
                ...
                <span class="text-[9px] font-normal">(<?php echo e($selectedPeriod == 'bosy' ? 'Beginning' : 'End'); ?> of School Year)</span>
            </div>
            ...
            <table class="sf8-table">
                ...
                <tbody>
                    ...
                    <?php $maleData = $healthData->where('gender', 'M'); ?>
                    ...
                    <tr>
                        ...
                        <td class="text-[8px]"><?php echo e($data['lrn']); ?></td>
                        <td class="text-left uppercase text-[8px] data-cell pl-2" title="<?php echo e($data['full_name']); ?>"><?php echo e($data['full_name']); ?></td>
                        <td class="text-[8px]"><?php echo e($data['birthdate']); ?></td>
                        <td class="text-[8px]"><?php echo e($data['age_formatted']); ?></td>
                        <td class="font-bold">M</td>
                        <td class="font-bold text-[9px]"><?php echo e($data['weight'] ?? ''); ?></td>
                        <td class="text-[8px]"><?php echo e($data['height'] ?? ''); ?></td>
                        <td class="text-[8px]"><?php echo e($data['height_squared'] ?? ''); ?></td>
                        <td class="font-bold text-[9px]"><?php echo e($data['bmi'] ?? ''); ?></td>
                        <td class="nutritional-<?php echo e(strtolower(str_replace(' ', '-', $data['nutritional_status']))); ?> text-[8px]">
                            <?php echo e($data['nutritional_status'] ?? 'Not Assessed'); ?>

                        </td>
                        <td class="hfa-<?php echo e(strtolower(str_replace(' ', '-', $data['height_for_age']))); ?> text-[8px]">
                            <?php echo e($data['height_for_age'] ?? 'Not Assessed'); ?>

                        </td>
                        <td class="text-[8px]"><?php echo e($data['remarks'] ?? ''); ?></td>
                        <td class="no-print">
                            <button onclick="openHealthModal(<?php echo e($data['student']->id); ?>, '<?php echo e($data['full_name']); ?>', <?php echo e($data['weight'] ?? 'null'); ?>, <?php echo e($data['height'] ?? 'null'); ?>, '<?php echo e($data['remarks'] ?? ''); ?>', <?php echo e($data['age'] ?? 'null'); ?>, 'M')" class="text-indigo-600 hover:text-indigo-800">
                                <i class="fas fa-<?php echo e($data['health_record_id'] ? 'edit' : 'plus'); ?>"></i>
                            </button>
                        </td>
                    </tr>
                    ...
                    <?php $femaleData = $healthData->where('gender', 'F'); ?>
                    ...
                    <tr>
                        <td><?php echo e($maleData->count() + $index + 1); ?></td>
                        <td class="text-[8px]"><?php echo e($data['lrn']); ?></td>
                        <td class="text-left uppercase text-[8px] data-cell pl-2" title="<?php echo e($data['full_name']); ?>"><?php echo e($data['full_name']); ?></td>
                        <td class="text-[8px]"><?php echo e($data['birthdate']); ?></td>
                        <td class="text-[8px]"><?php echo e($data['age_formatted']); ?></td>
                        ...
                        <td class="text-[8px]"><?php echo e($data['remarks'] ?? ''); ?></td>
                        <td class="no-print">
                            <button onclick="openHealthModal(<?php echo e($data['student']->id); ?>, '<?php echo e($data['full_name']); ?>', <?php echo e($data['weight'] ?? 'null'); ?>, <?php echo e($data['height'] ?? 'null'); ?>, '<?php echo e($data['remarks'] ?? ''); ?>', <?php echo e($data['age'] ?? 'null'); ?>, 'F')" class="text-indigo-600 hover:text-indigo-800">
                                <i class="fas fa-<?php echo e($data['health_record_id'] ? 'edit' : 'plus'); ?>"></i>
                            </button>
                        </td>
                    </tr>
                ...
                <table class="sf8-table">
                    ...
                    <tbody>
                        <tr class="nutritional-severely-wasted">
                            ...
                            <td><?php echo e($summaryStats['male_severely_wasted'] > 0 ? $summaryStats['male_severely_wasted'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_severely_wasted'] > 0 ? $summaryStats['female_severely_wasted'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_severely_wasted'] + $summaryStats['female_severely_wasted']) > 0 ? ($summaryStats['male_severely_wasted'] + $summaryStats['female_severely_wasted']) : ''); ?></td>
                        </tr>
                        <tr class="nutritional-wasted">
                            <td class="text-left pl-2 font-bold text-[8px]">Wasted</td>
                            <td><?php echo e($summaryStats['male_wasted'] > 0 ? $summaryStats['male_wasted'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_wasted'] > 0 ? $summaryStats['female_wasted'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_wasted'] + $summaryStats['female_wasted']) > 0 ? ($summaryStats['male_wasted'] + $summaryStats['female_wasted']) : ''); ?></td>
                        </tr>
                        <tr class="nutritional-normal">
                            <td class="text-left pl-2 font-bold text-[8px]">Normal</td>
                            <td><?php echo e($summaryStats['male_normal'] > 0 ? $summaryStats['male_normal'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_normal'] > 0 ? $summaryStats['female_normal'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_normal'] + $summaryStats['female_normal']) > 0 ? ($summaryStats['male_normal'] + $summaryStats['female_normal']) : ''); ?></td>
                        </tr>
                        <tr class="nutritional-overweight">
                            <td class="text-left pl-2 font-bold text-[8px]">Overweight</td>
                            <td><?php echo e($summaryStats['male_overweight'] > 0 ? $summaryStats['male_overweight'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_overweight'] > 0 ? $summaryStats['female_overweight'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_overweight'] + $summaryStats['female_overweight']) > 0 ? ($summaryStats['male_overweight'] + $summaryStats['female_overweight']) : ''); ?></td>
                        </tr>
                        <tr class="nutritional-obese">
                            <td class="text-left pl-2 font-bold text-[8px]">Obese</td>
                            <td><?php echo e($summaryStats['male_obese'] > 0 ? $summaryStats['male_obese'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_obese'] > 0 ? $summaryStats['female_obese'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_obese'] + $summaryStats['female_obese']) > 0 ? ($summaryStats['male_obese'] + $summaryStats['female_obese']) : ''); ?></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="sf8-table">
                    ...
                    <tbody>
                        <tr class="hfa-severely-stunted">
                            ...
                            <td><?php echo e($summaryStats['male_severely_stunted'] > 0 ? $summaryStats['male_severely_stunted'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_severely_stunted'] > 0 ? $summaryStats['female_severely_stunted'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_severely_stunted'] + $summaryStats['female_severely_stunted']) > 0 ? ($summaryStats['male_severely_stunted'] + $summaryStats['female_severely_stunted']) : ''); ?></td>
                        </tr>
                        <tr class="hfa-stunted">
                            <td class="text-left pl-2 font-bold text-[8px]">Stunted</td>
                            <td><?php echo e($summaryStats['male_stunted'] > 0 ? $summaryStats['male_stunted'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_stunted'] > 0 ? $summaryStats['female_stunted'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_stunted'] + $summaryStats['female_stunted']) > 0 ? ($summaryStats['male_stunted'] + $summaryStats['female_stunted']) : ''); ?></td>
                        </tr>
                        <tr class="hfa-normal">
                            <td class="text-left pl-2 font-bold text-[8px]">Normal</td>
                            <td><?php echo e($summaryStats['male_normal_hfa'] > 0 ? $summaryStats['male_normal_hfa'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_normal_hfa'] > 0 ? $summaryStats['female_normal_hfa'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_normal_hfa'] + $summaryStats['female_normal_hfa']) > 0 ? ($summaryStats['male_normal_hfa'] + $summaryStats['female_normal_hfa']) : ''); ?></td>
                        </tr>
                        <tr class="hfa-tall">
                            <td class="text-left pl-2 font-bold text-[8px]">Tall</td>
                            <td><?php echo e($summaryStats['male_tall'] > 0 ? $summaryStats['male_tall'] : ''); ?></td>
                            <td><?php echo e($summaryStats['female_tall'] > 0 ? $summaryStats['female_tall'] : ''); ?></td>
                            <td class="font-bold"><?php echo e(($summaryStats['male_tall'] + $summaryStats['female_tall']) > 0 ? ($summaryStats['male_tall'] + $summaryStats['female_tall']) : ''); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div id="healthModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 no-print">
        <div class="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <form id="healthForm" method="POST" action="<?php echo e(route('teacher.sf8.store')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="student_id" id="studentId">
                <input type="hidden" name="section_id" value="<?php echo e($selectedSection?->id); ?>">
                <input type="hidden" name="period" value="<?php echo e($selectedPeriod); ?>">
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\school-forms\sf8.blade.php ENDPATH**/ ?>