...
<body class="bg-slate-100 min-h-screen" x-data="{ mobileOpen: false }" @keydown.escape.window="mobileOpen = false">
    ...
    <div class="lg:ml-72 p-6" id="main-content">
        ...
        <div class="no-print mb-4 bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <form method="GET" action="<?php echo e(route('teacher.sf10')); ?>" class="flex items-end gap-4">
                <div class="flex-1">
                    ...
                    <select name="student_id" onchange="this.form.submit()"
                        ...
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($student->id); ?>">
                                <?php echo e($student->user->last_name ?? ''); ?>, <?php echo e($student->user->first_name ?? ''); ?> <?php echo e($student->user->middle_name ?? ''); ?> (<?php echo e($student->lrn ?? ''); ?>)
                            </option>
...
<div class="overflow-x-auto pb-4">`n            <div class="sf10-container">
                ...
                <table class="sf10-header-table">
                    <tr>
                        <td style="width: 70px; text-align: center; vertical-align: middle;">
                            ...
                            <img src="<?php echo e(asset('images/edukasyon.jpg')); ?>" alt="DepEd Logo" style="width: 55px; height: auto;">
                        </td>
                        ...
                        <td style="width: 70px; text-align: center; vertical-align: middle;">
                            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="DepEd" style="width: 65px; height: auto;">
                        </td>
                    </tr>
                </table>
                    ...
                    <div class="sf10-section-body">
                        <table style="width: 100%; border-collapse: collapse; margin-bottom: 2px;">
                            <tr>
                                ...
                                <td style="border: none; padding: 1px 0; border-bottom: 1px solid #000; width: 8%;"><?php echo e(strtoupper($nameExtension)); ?></td>
                ...
                <div class="sf10-section">
                    ...
                    <div class="sf10-section-body">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 4px 16px; margin-bottom: 2px;">
                            ...
                            <span>Address of School: <span class="u" style="min-width: 150px;"><?php echo e($schoolAddress ?? ''); ?></span></span>
                        </div>
                ...
                <div class="sf10-section" style="border-top: none;">
                    <div class="sf10-section-body" style="padding: 2px;">
                        <?php if(isset($allGradeLevels) && count($allGradeLevels) > 0): ?>
                            <div class="scholastic-columns">
                                <?php $__currentLoopData = $allGradeLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gradeLevel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                                    ...
                                                    <div class="scholastic-block">
                                                        ...
                                                        <div class="scholastic-block-header">
                                                            <div class="scholastic-block-header-row">
                                                                <span>School: <span class="u" style="min-width: 100px;"><?php echo e($schoolInfo->school_name ?? $schoolName); ?></span></span>
                                                                <span>School ID: <span class="u" style="min-width: 50px;"><?php echo e($schoolInfo->school_id ?? $schoolId); ?></span></span>
                                                            </div>
                                                            <div class="scholastic-block-header-row">
                                                                <span>District: <span class="u" style="min-width: 60px;"><?php echo e($schoolInfo->district ?? $schoolDistrict); ?></span></span>
                                                                <span>Division: <span class="u" style="min-width: 80px;"><?php echo e($schoolInfo->division ?? $schoolDivision); ?></span></span>
                                                                <span>Region: <span class="u" style="min-width: 40px;"><?php echo e($schoolInfo->region ?? $schoolRegion); ?></span></span>
                                                            </div>
                                                            <div class="scholastic-block-header-row">
                                                                <span>Classified as Grade: <span class="u" style="min-width: 25px;"><?php echo e(str_replace(['Grade ', 'Kindergarten'], ['', 'K'], $gradeLevel)); ?></span></span>
                                                                <span>Section: <span class="u" style="min-width: 60px;"><?php echo e($schoolInfo->section ?? ''); ?></span></span>
                                                                <span>School Year: <span class="u" style="min-width: 60px;"><?php echo e($schoolInfo->school_year ?? ''); ?></span></span>
                                                            </div>
                                                            <div class="scholastic-block-header-row">
                                                                <span>Name of Adviser/Teacher: <span class="u" style="min-width: 120px;"><?php echo e($schoolInfo->adviser ?? ''); ?></span></span>
                                                                <span>Signature: <span class="u" style="min-width: 80px;"></span></span>
                                                            </div>
                                                        </div>

                                                        <?php if($isKindergartenGrade): ?>
                                                            <!-- KINDERGARTEN DOMAINS -->
                                                            <table class="grades-table">
                                                                <thead>
                                                                    <tr>
                                                                        <th rowspan="2" style="width: 50%; text-align: left; padding-left: 4px;">
                                                                            <?php echo e($lang == 'cebuano' ? 'MGA KAHILIAN (DOMAINS)' : 'DOMAINS'); ?>

                                                                        </th>
                                                                        <th colspan="4"><?php echo e($lang == 'cebuano' ? 'MARKAHAN (QUARTER)' : 'QUARTER'); ?></th>
                                                                    </tr>
                                                                    <tr>
                                                                ...
                                                                <tbody>
                                                                    <?php $__empty_1 = true; $__currentLoopData = $kinderConfig; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domainKey => $domainData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        ...
                                                                        <?php if(isset($domainData['subdomains'])): ?>
                                                                            <?php $__currentLoopData = $domainData['subdomains']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subdomainKey => $subdomainData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php $__currentLoopData = $subdomainData['indicators']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indicatorKey => $indicatorText): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <tr>
                                                                                    <td class="text-left" style="font-size: 6.5pt; padding-left: 10px; line-height: 1.3;">
                                                                                        <?php echo e($indicatorText[$lang] ?? $indicatorText['cebuano']); ?>
                                                                                ...
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php elseif(isset($domainData['indicators'])): ?>
                                                            ...
                                                            <table class="grades-table">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        ...
                                                                        $subjectCount = 0;
                                                                    ?>
                                                                    <?php $__empty_1 = true; $__currentLoopData = $subjectsForGrade; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <?php
                                                                        ...
                                                                        ?>
                                                                        <tr>
                                                                            <td class="text-left" style="font-size: 6.5pt; padding-left: 4px;"><?php echo e($subject->name); ?></td>
                                                                            <td><?php echo e($q1 ?? ''); ?></td>
                                                                            <td><?php echo e($q2 ?? ''); ?></td>
                                                                            <td><?php echo e($q3 ?? ''); ?></td>
                                                                            <td><?php echo e($q4 ?? ''); ?></td>
                                                                    ...
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                                        <tr>
                                                                            <td colspan="7" style="text-align: center; font-size: 7pt; color: #6b7280;">No subjects found for <?php echo e($gradeLevel); ?></td>
                                                                        </tr>
                                                                    <?php endif; ?>
            ...
            <div class="no-print" style="width: 300px; flex-shrink: 0;">
                ...
                <div class="bg-white rounded-lg shadow-md border border-slate-200 mb-4 overflow-hidden">
                    ...
                    <div class="p-4">
                        <form method="GET" action="<?php echo e(route('teacher.sf10')); ?>">
                            <select name="student_id" onchange="this.form.submit()"
                ...
                <div class="bg-white rounded-lg shadow-md border border-slate-200 mb-4 overflow-hidden">
                    ...
                    <div class="p-4 text-sm">
                        <div class="mb-2"><span class="text-slate-500">Name:</span> <span class="font-semibold"><?php echo e($user->last_name ?? ''); ?>, <?php echo e($user->first_name ?? ''); ?></span></div>
                        <div class="mb-2"><span class="text-slate-500">LRN:</span> <span class="font-semibold"><?php echo e($selectedStudent->lrn ?? 'N/A'); ?></span></div>
                        <div class="mb-2"><span class="text-slate-500">Birthdate:</span> <span class="font-semibold"><?php echo e($selectedStudent->birthdate ? \Carbon\Carbon::parse($selectedStudent->birthdate)->format('m/d/Y') : 'N/A'); ?></span></div>
                        <div><span class="text-slate-500">Sex:</span> <span class="font-semibold"><?php echo e($selectedStudent->gender ?? 'N/A'); ?></span></div>
                    </div>
                </div>
                    ...
                    <div class="p-4 space-y-3">
                        <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-slate-800"><?php echo e(count(array_filter($allGradeLevels ?? [], fn($g) => isset($historicalGrades[$g]) && $historicalGrades[$g]->count() > 0))); ?></p>
                            </div>
                        </div>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views/teacher/school-forms/sf10.blade.php ENDPATH**/ ?>