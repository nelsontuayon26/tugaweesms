...
<body class="min-h-screen bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 text-center">
        ...
        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6 mb-6">
            ...
            <p class="text-3xl font-bold text-indigo-600"><?php echo e($application->application_number); ?></p>
        </div>
        
        <div class="text-left bg-slate-50 rounded-xl p-4 mb-6 space-y-2">
            <div class="flex justify-between">
                <span class="text-slate-500">Student:</span>
                <span class="font-medium"><?php echo e($application->student_full_name); ?></span>
            </div>
            <div class="flex justify-between">
        ...
        <div class="space-y-3 text-sm text-slate-600 mb-6 text-left">
            <p><i class="fas fa-envelope text-indigo-500 mr-2 w-5"></i>Confirmation sent to <?php echo e($application->parent_email); ?></p>
        ...
        <div class="flex flex-col gap-3">
            <a href="<?php echo e(route('enrollment.check')); ?>" class="px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 font-semibold transition-all flex items-center justify-center gap-2">
                <i class="fas fa-search"></i> Check Status
            </a>
            <a href="<?php echo e(route('enrollment.form')); ?>" class="px-6 py-3 text-slate-600 hover:bg-slate-100 rounded-xl transition-all">
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\enrollment\success.blade.php ENDPATH**/ ?>