...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-lg">
        ...
        <div class="mt-4 text-center">
            <a href="<?php echo e(route('admin.school-years.index')); ?>" class="text-blue-600 hover:underline">
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\school-years\create.blade.php ENDPATH**/ ?>