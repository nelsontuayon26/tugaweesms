<?php $__env->startSection('title', 'Post Announcement'); ?>
<?php $__env->startSection('header-title', 'Post New Announcement'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-3xl mx-auto" x-data="announcementForm()">
    <form action="<?php echo e(route('admin.announcements.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" @submit="return validateForm()">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\announcements\create.blade.php ENDPATH**/ ?>