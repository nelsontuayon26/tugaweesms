...
<?php $__env->startSection('header-title', 'My Profile'); ?>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="px-6 pb-6 relative">
                    ...
                    <div class="text-center">
                        <h2 class="text-xl font-bold text-slate-900"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h2>
                        ...
                        <div class="flex items-center justify-center gap-2 mt-3">
                            ...
                            <span class="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-bold rounded-full capitalize"><?php echo e($user->is_active ? 'Active' : 'Inactive'); ?></span>
                        </div>
                    </div>

                    <div class="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-slate-100">
                        <div class="text-center">
                            <p class="text-lg font-bold text-slate-900"><?php echo e($user->created_at->format('M d, Y')); ?></p>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider">Member Since</p>
                        </div>
                        <div class="text-center border-l border-slate-100">
                            <p class="text-lg font-bold text-slate-900"><?php echo e($user->last_login_at ? $user->last_login_at->diffForHumans() : 'Never'); ?></p>
        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                ...
                <form x-ref="profileForm" action="<?php echo e(route(($routePrefix ?? 'admin') . '.profile.update')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="p-4 bg-slate-50 rounded-xl">
                        ...
                        <p class="text-base font-bold text-slate-900 font-mono">#<?php echo e($user->id); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div x-show="showPhotoModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div x-show="showPhotoModal"
            ...
            <form action="<?php echo e(route(($routePrefix ?? 'admin') . '.profile.photo')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="p-6">
    ...
    <div x-show="showPasswordModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div x-show="showPasswordModal"
            ...
            <form action="<?php echo e(route(($routePrefix ?? 'admin') . '.profile.password')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div x-show="showDeleteModal"
            ...
            <div class="p-6 text-center">
                ...
                <form action="<?php echo e(route(($routePrefix ?? 'admin') . '.profile.delete')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="text-rose-500 text-sm mt-1 text-left"><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        function adminProfileApp() {
            return {
                ...
                formData: {
                    first_name: <?php echo json_encode($user->first_name ?? '', 15, 512) ?>,
                    last_name: <?php echo json_encode($user->last_name ?? '', 15, 512) ?>,
                    username: <?php echo json_encode($user->username ?? '', 15, 512) ?>,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\profile\index.blade.php ENDPATH**/ ?>