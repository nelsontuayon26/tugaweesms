    ...
    <div class="lg:ml-72 p-4">
        ...
        <div class="mb-4 flex items-center justify-between no-print">
            ...
            <div class="px-3 py-1.5 rounded-lg bg-indigo-50 border border-indigo-200 text-indigo-700 text-sm font-medium">
                <i class="fas fa-id-card mr-1"></i>SY <?php echo e($activeSchoolYear?->name ?? now()->format('Y')); ?>
        ...
        <div class="sf7-container rounded-xl shadow-lg border border-slate-200 overflow-x-auto">
            ...
            <div class="flex items-start gap-3 mb-2">
                <div class="flex-shrink-0">
                    <img src="<?php echo e(asset('images/deped-logo.png')); ?>" alt="DepEd" class="w-14 h-14 object-contain"
            ...
            <div class="school-info-row">
                <div><label>School ID</label><div class="underline"><?php echo e($schoolId); ?></div></div>
                <div><label>Region</label><div class="underline"><?php echo e($schoolRegion); ?></div></div>
                <div><label>Division</label><div class="underline"><?php echo e($schoolDivision); ?></div></div>
            </div>
            <div class="school-info-row">
                <div><label>School Name</label><div class="underline"><?php echo e($schoolName); ?></div></div>
                <div><label>District</label><div class="underline"><?php echo e($schoolDistrict); ?></div></div>
                <div><label>School Year</label><div class="underline"><?php echo e($activeSchoolYear?->name ?? ''); ?></div></div>
            </div>
            ...
            <table class="sf7-table mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($teachingCount); ?></td>
            ...
            <table class="sf7-table mt-2">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $personnelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <?php for($i = 0; $i < $rowCount; $i++): ?>
                            ...
                            <tr>
                                <?php if($i === 0): ?>
                                    <td rowspan="<?php echo e($rowCount); ?>"><?php echo e($person['employee_no']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left font-bold" style="font-size: 9px;">
                                        <?php echo e($person['last_name']); ?>, <?php echo e($person['first_name']); ?> <?php echo e($person['middle_name']); ?>

                                    </td>
                                    <td rowspan="<?php echo e($rowCount); ?>"><?php echo e($person['sex']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>"><?php echo e($person['fund_source']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left" style="font-size: 8px;"><?php echo e($person['position']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left" style="font-size: 8px;"><?php echo e($person['nature_of_appointment']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left" style="font-size: 8px;"><?php echo e($person['highest_degree']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left" style="font-size: 8px;"><?php echo e($person['major']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left" style="font-size: 8px;"><?php echo e($person['minor']); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left" style="font-size: 8px;">
                                        <?php echo e($assignmentText ?: '-'); ?>

                                    </td>
                                <?php endif; ?>
                                <td><?php echo e($prog['day'] ?? ''); ?></td>
                                <td><?php echo e($prog['from'] ?? ''); ?></td>
                                <td><?php echo e($prog['to'] ?? ''); ?></td>
                                <?php if($i === 0): ?>
                                    <td rowspan="<?php echo e($rowCount); ?>"><?php echo e($person['total_minutes'] ?: ''); ?></td>
                                    <td rowspan="<?php echo e($rowCount); ?>" class="text-left" style="font-size: 8px;"><?php echo e($person['remarks']); ?></td>
                                <?php endif; ?>
                            </tr>
                        <?php endfor; ?>
            ...
            <div class="mt-4 grid grid-cols-3 gap-6 text-xs px-4">
                <div class="text-center">
                    ...
                    <div class="mt-6 border-t border-black pt-1">
                        <p class="text-center font-bold uppercase text-xs"><?php echo e(auth()->user()->teacher?->full_name ?? auth()->user()->name); ?></p>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\school-forms\sf7.blade.php ENDPATH**/ ?>