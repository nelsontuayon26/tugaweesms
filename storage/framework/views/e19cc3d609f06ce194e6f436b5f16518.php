...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-0 py-2 space-y-0.5 overflow-y-auto"
        ...
        <a href="<?php echo e(route('principal.dashboard')); ?>"
           class="principal-nav-item <?php echo e(request()->routeIs('principal.dashboard') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('principal.students.index')); ?>"
           class="principal-nav-item <?php echo e(request()->routeIs('principal.students.*') ? 'active' : ''); ?>">
            <div class="principal-nav-icon">
                <i class="fas fa-users"></i>
            </div>
            <span>Pupils</span>
            <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-800 px-2 py-0.5 rounded-md"><?php echo e($sidebarStudentCount); ?></span>
        </a>

        <a href="<?php echo e(route('principal.teachers.index')); ?>"
           class="principal-nav-item <?php echo e(request()->routeIs('principal.teachers.*') ? 'active' : ''); ?>">
            <div class="principal-nav-icon">
                <i class="fas fa-chalkboard-teacher"></i>
            </div>
            <span>Teachers</span>
            <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-800 px-2 py-0.5 rounded-md"><?php echo e($sidebarTeacherCount); ?></span>
        </a>

        <a href="<?php echo e(route('principal.sections.index')); ?>"
           class="principal-nav-item <?php echo e(request()->routeIs('principal.sections.*') ? 'active' : ''); ?>">
            <div class="principal-nav-icon">
                <i class="fas fa-th-large"></i>
            </div>
            <span>Sections</span>
            <span class="ml-auto text-[10px] font-bold text-slate-500 bg-slate-800 px-2 py-0.5 rounded-md"><?php echo e($sidebarSectionCount); ?></span>
        </a>

        <p class="px-5 pt-5 pb-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Operations</p>

        <a href="<?php echo e(route('principal.pending-registrations.index')); ?>"
           class="principal-nav-item <?php echo e(request()->routeIs('principal.pending-registrations.*') ? 'active' : ''); ?>">
            <div class="principal-nav-icon">
                <i class="fas fa-user-clock"></i>
            </div>
            <span>Pending</span>
            <?php if($sidebarPendingCount > 0): ?>
                <span class="ml-auto text-[10px] font-bold text-amber-400 bg-amber-900/30 px-2 py-0.5 rounded-md"><?php echo e($sidebarPendingCount); ?></span>
            <?php endif; ?>
        </a>

        <a href="<?php echo e(route('principal.reports.index')); ?>"
           class="principal-nav-item <?php echo e(request()->routeIs('principal.reports.*') ? 'active' : ''); ?>">
            <div class="principal-nav-icon">
        ...
        <a href="<?php echo e(route('principal.school-years.index')); ?>"
           class="principal-nav-item <?php echo e(request()->routeIs('principal.school-years.*') ? 'active' : ''); ?>">
            <div class="principal-nav-icon">
        ...
        <div class="principal-user-card" onclick="document.getElementById('principalUserMenu').classList.toggle('hidden')">
            <div class="flex items-center gap-3">
                <?php if(auth()->user()->photo): ?>
                    <img src="<?php echo e(profile_photo_url(auth()->user()->photo)); ?>" alt="" class="w-9 h-9 rounded-full border-2 border-amber-500/30 object-cover">
                <?php else: ?>
                    <div class="w-9 h-9 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold text-sm">
                        <?php echo e(strtoupper(substr(auth()->user()->first_name ?? 'P', 0, 1))); ?>

                    </div>
                <?php endif; ?>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-white truncate"><?php echo e(auth()->user()->name ?? 'Principal'); ?></p>
            ...
            <div id="principalUserMenu" class="hidden mt-3 pt-3 border-t border-white/5 space-y-1">
                <a href="<?php echo e(route('principal.profile')); ?>" class="flex items-center gap-2 px-2 py-1.5 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-white/5 transition-colors">
                    <i class="fas fa-user text-xs w-4"></i> Profile
                </a>
                 <a href="<?php echo e(route('principal.activity-logs.index')); ?>" class="flex items-center gap-2 px-2 py-1.5 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-white/5 transition-colors">
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\principal\includes\sidebar.blade.php ENDPATH**/ ?>