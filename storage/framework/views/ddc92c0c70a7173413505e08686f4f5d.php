    ...
    <div class="main-wrapper">
        <div class="main-content">
            <div class="max-w-5xl mx-auto pb-8">
                ...
                <?php if(isset($activeSchoolYear) && $activeSchoolYear): ?>
                    <div class="school-year-banner animate-fade-in">
                        <i class="fas fa-calendar-check text-amber-600"></i>
                        <span>Showing students for Active School Year: <?php echo e($activeSchoolYear->name); ?></span>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="flex items-center gap-3 mb-1">
                                <h1 class="text-3xl font-bold text-slate-900">Section <?php echo e($section->name); ?></h1>
                            ...
                            <p class="text-slate-500 flex items-center gap-2">
                                ...
                                <?php echo e($section->schoolYear->name ?? 'No School Year'); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-fade-in stagger-1">
                    <div class="stat-card">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-2xl font-bold text-slate-900"><?php echo e($studentCount); ?></span>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-xs text-slate-400 mt-1"><?php echo e(round($percentage)); ?>% of <?php echo e($capacity); ?> capacity</p>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <p class="text-xs text-slate-400 mt-1">Level <?php echo e($section->gradeLevel->level ?? '-'); ?></p>
                    </div>
                    ...
                    <div class="stat-card">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-lg font-bold text-slate-900 text-right truncate max-w-[120px]">
                                <?php echo e($section->teacher->last_name ?? 'None'); ?>

                            </span>
                        </div>
                        <p class="text-sm font-semibold text-slate-600">Adviser</p>
                        <p class="text-xs text-slate-400 mt-1">
                            <?php echo e($section->teacher ? 'Assigned' : 'Not assigned'); ?>
                    ...
                    <div class="stat-card">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-lg font-bold text-slate-900 text-right">
                                <?php echo e($section->room_number ?? 'TBA'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-900"><?php echo e($section->name); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-900"><?php echo e($section->gradeLevel->name ?? 'Not assigned'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-900"><?php echo e($section->teacher->full_name ?? 'Not assigned'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-900"><?php echo e($section->room_number ?? 'Not assigned'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-900"><?php echo e($capacity); ?> students</p>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-slate-900"><?php echo e($section->schoolYear->name ?? 'Not set'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-card overflow-hidden animate-fade-in stagger-3">
                    <div class="p-6 border-b border-slate-100 flex items-center justify-between">
                        <h3 class="text-lg font-bold text-slate-900 flex items-center gap-2">
                            ...
                            <span class="bg-emerald-100 text-emerald-700 text-xs px-2.5 py-1 rounded-full font-bold"><?php echo e($studentCount); ?></span>
                        </h3>
                        <a href="<?php echo e(route('admin.students.create')); ?>?section_id=<?php echo e($section->id); ?>" class="btn-primary text-sm py-2 px-4">
                    ...
                    <table class="modern-table w-full">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $section->active_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr>
                                    <td>
                                        <span class="text-sm font-semibold text-slate-400">#<?php echo e($index + 1); ?></span>
                                    </td>
                                    <td>
                                        <div class="flex items-center gap-3">
                                            <div class="student-avatar">
                                                <?php echo e(strtoupper(substr($student->user->first_name ?? $student->first_name, 0, 1) . substr($student->user->last_name ?? $student->last_name, 0, 1))); ?>

                                            </div>
                                            <div>
                                                <p class="font-semibold text-slate-900">
                                                    <?php echo e(($student->user->last_name ?? $student->last_name) . ', ' . ($student->user->first_name ?? $student->first_name)); ?>

                                                </p>
                                                <p class="text-xs text-slate-500">ID: <?php echo e($student->student_id ?? 'N/A'); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <span class="text-xs text-slate-500 flex items-center gap-1">
                                                ...
                                                <?php echo e($student->contact_number ?? 'No contact'); ?>

                                            </span>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="text-sm font-semibold text-slate-700"><?php echo e($sex); ?></span>
                                    </td>
                                    <td>
                                        ...
                                        <?php if($enrollment && $enrollment->enrollment_date): ?>
                                            <p class="text-xs text-slate-400 mt-1"><?php echo e($enrollment->enrollment_date->format('M d, Y')); ?></p>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="flex gap-1">
                                            <a href="<?php echo e(route('admin.students.show', $student)); ?>" class="action-btn-sm hover:text-blue-600" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('admin.students.edit', $student)); ?>" class="action-btn-sm hover:text-amber-600" title="Edit">
                                    ...
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <?php if(isset($activeSchoolYear)): ?>
                                                <p class="text-xs text-slate-400 mb-6">School Year: <?php echo e($activeSchoolYear->name); ?></p>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('admin.students.create')); ?>?section_id=<?php echo e($section->id); ?>" class="btn-primary">
            ...
            <div class="fixed bottom-8 right-8 flex flex-col gap-3 z-50">
                <a href="<?php echo e(route('admin.sections.id-cards', $section)); ?>"
                ...
                <a href="<?php echo e(route('admin.sections.edit', $section)); ?>" 
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\sections\show.blade.php ENDPATH**/ ?>