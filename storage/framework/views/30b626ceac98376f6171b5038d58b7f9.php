...
<head>
    ...
    <title>ID Cards - <?php echo e($section->name); ?> | Tugawe Elementary</title>
    ...
    <div class="modal-panel w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden" @click.stop>
        ...
        <div class="no-print bg-white border-b border-slate-200 px-5 py-4 flex items-center justify-between sticky top-0 z-50">
            <div>
                ...
                <p class="text-sm text-slate-500"><?php echo e($section->name); ?> • <?php echo e($section->gradeLevel->name ?? ''); ?> • <?php echo e($students->count()); ?> students</p>
            </div>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\sections\id-cards.blade.php ENDPATH**/ ?>