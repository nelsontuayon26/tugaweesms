<?php $__env->startSection('title', 'Seating Chart - ' . $section->name); ?>
...
<div class="container mx-auto px-4 py-6" x-data="seatingChart()" x-init="init()">
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div class="mt-4 md:mt-0 flex space-x-3">
            <a href="<?php echo e(route('teacher.seating.roster', $section)); ?>" 
...
<script>
    function seatingChart() {
        return {
            ...
            seatingArrangement: <?php echo json_encode($seatingArrangement ?? [], 15, 512) ?>,
            unassignedStudents: [],
            assignedSeats: {},
            saving: false,
            message: '',
            ...
            async saveArrangement() {
                ...
                try {
                    const response = await fetch('<?php echo e(route('teacher.seating.save', $section)); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\seating\index.blade.php ENDPATH**/ ?>