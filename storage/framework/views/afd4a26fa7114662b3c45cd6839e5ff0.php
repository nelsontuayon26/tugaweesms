...
<?php $__env->startSection('content'); ?>
        ...
        <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-4">
                <div>
                    ...
                    <p class="text-xs text-stone-500 mt-0.5"><?php echo e(now()->format('l, F j, Y')); ?></p>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <?php if($activeSchoolYear): ?>
                    <span class="px-3 py-1.5 bg-amber-50 text-amber-700 rounded-lg text-xs font-bold border border-amber-200">
                        <i class="fas fa-graduation-cap mr-1"></i> <?php echo e($activeSchoolYearName); ?>

                    </span>
                <?php endif; ?>
                <a href="<?php echo e(route('principal.reports.index')); ?>" class="hidden sm:flex items-center gap-2 p-btn-amber">
    ...
    <main class="principal-content">
        ...
        <!-- Welcome -->
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-stone-900">Welcome back, <?php echo e(auth()->user()->first_name ?? 'Principal'); ?>!</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
            <div class="p-card p-stat p-5">
                <div class="flex items-start justify-between mb-3">
                    ...
                    <span class="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-100">
                        <?php echo e($maleStudents); ?>M / <?php echo e($femaleStudents); ?>F
                    </span>
                </div>
                <p class="text-2xl font-bold text-stone-900"><?php echo e(number_format($totalStudents)); ?></p>
            ...
            <div class="p-card p-stat p-5">
                <div class="flex items-start justify-between mb-3">
                    ...
                    <span class="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-100">
                        <?php echo e($totalTeachers > 0 ? round(($activeTeachers / $totalTeachers) * 100) : 0); ?>% active
                    </span>
                </div>
                <p class="text-2xl font-bold text-stone-900"><?php echo e(number_format($totalTeachers)); ?></p>
            ...
            <div class="p-card p-stat p-5">
                <div class="flex items-start justify-between mb-3">
                    ...
                    ?>
                    <span class="text-[10px] font-bold <?php echo e($attendanceRate >= 90 ? 'text-emerald-600 bg-emerald-50 border-emerald-100' : 'text-amber-600 bg-amber-50 border-amber-100'); ?> px-2 py-0.5 rounded-md border">
                        <?php echo e($attendanceRate); ?>%
                    </span>
                </div>
                <p class="text-2xl font-bold text-stone-900"><?php echo e($attendanceRate); ?>%</p>
            ...
            <div class="p-card p-stat p-5">
                ...
                <p class="text-2xl font-bold text-stone-900"><?php echo e(number_format($avgGrade, 1)); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
            <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
                <a href="<?php echo e(route('principal.pending-registrations.index')); ?>" class="p-card p-5 hover:shadow-lg transition-all group">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-stone-900"><?php echo e($pendingRegistrations); ?></p>
                            <p class="text-xs text-stone-500 font-medium">Pending Registrations</p>
                        </div>
                    </div>
                </a>
                <a href="<?php echo e(route('principal.enrollment.index')); ?>" class="p-card p-5 hover:shadow-lg transition-all group">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-stone-900"><?php echo e($pendingEnrollments); ?></p>
                            <p class="text-xs text-stone-500 font-medium">Online Enrollments</p>
                        </div>
                    </div>
                </a>
                <a href="<?php echo e(route('principal.sections.index')); ?>" class="p-card p-5 hover:shadow-lg transition-all group">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-stone-900"><?php echo e($totalSections); ?></p>
                ...
                <div class="p-card p-5">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-stone-900"><?php echo e($absentToday + $lateToday); ?></p>
            ...
            <div class="p-card p-5">
                ...
                <p class="text-[10px] text-stone-400 mb-4 uppercase tracking-wide font-semibold"><?php echo e($activeSchoolYearName); ?></p>
                <div class="space-y-3">
                    <?php $maxCount = !empty($gradeDistribution) ? max($gradeDistribution) : 1; ?>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex justify-between items-center mb-1">
                                    <span class="font-semibold text-stone-700 text-xs"><?php echo e($grade); ?></span>
                                    <span class="font-bold text-stone-900 text-sm"><?php echo e($count); ?></span>
                                </div>
                                <div class="h-1.5 bg-stone-100 rounded-full overflow-hidden">
                                    <div class="h-full bg-gradient-to-r from-amber-400 to-orange-500 rounded-full" style="width: <?php echo e(($count / $maxCount) * 100); ?>%"></div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="p-card overflow-hidden">
            <div class="px-5 py-4 border-b border-stone-100 flex items-center justify-between bg-gradient-to-r from-stone-50 to-white">
                <div>
                    ...
                    <p class="text-[10px] text-stone-400 uppercase tracking-wide font-semibold mt-0.5"><?php echo e($activeSchoolYearName); ?></p>
                </div>
                <a href="<?php echo e(route('principal.students.index')); ?>" class="text-xs font-bold text-amber-600 hover:text-amber-700 bg-amber-50 hover:bg-amber-100 px-3 py-1.5 rounded-lg transition-colors">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $recentStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="flex items-center gap-3">
                                        <img src="<?php echo e($student->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($student->full_name) . '&background=f5f5f4&color=57534e'); ?>" alt="" class="w-8 h-8 rounded-full border border-stone-200">
                                        <div>
                                            <p class="font-bold text-stone-900 text-sm"><?php echo e($student->full_name); ?></p>
                                            <p class="text-[10px] text-stone-400"><?php echo e($student->gender); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="p-badge <?php echo e($student->status === 'active' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-stone-100 text-stone-600 border border-stone-200'); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
                                        <?php echo e(ucfirst($student->status)); ?>

                                    </span>
                                </td>
                                <td class="text-xs text-stone-500"><?php echo e($student->created_at->diffForHumans()); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
...
<?php echo $__env->make('layouts.principal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\principal\dashboard.blade.php ENDPATH**/ ?>