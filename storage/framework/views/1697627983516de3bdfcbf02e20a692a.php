...
<head>
    ...
    <title><?php echo e($event->title); ?> - Pupil Portal</title>
    ...
    <div class="flex-1 h-screen flex flex-col bg-slate-50 overflow-hidden transition-all duration-300 lg:ml-72">
        ...
        <div class="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shrink-0">
            <div class="flex items-center gap-4">
                ...
                <a href="<?php echo e(route('student.events.index')); ?>" class="w-10 h-10 rounded-xl bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-600 transition-colors">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-slate-50 border-t border-slate-200">
                        <a href="<?php echo e(route('student.events.index')); ?>" class="text-sm text-slate-600 hover:text-blue-600 transition-colors">
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\student\events\show.blade.php ENDPATH**/ ?>