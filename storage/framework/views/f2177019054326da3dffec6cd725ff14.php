...
<body class="antialiased bg-slate-100 min-h-screen">
    ...
    <nav class="bg-white border-b-2 border-slate-300 sticky top-0 z-50 shadow-sm">
        <div class="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
            <a href="<?php echo e(route('landing')); ?>" class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-10 w-10 rounded-lg object-cover border border-slate-200">
                <div>
            ...
            <a href="<?php echo e(route('landing')); ?>" class="text-sm font-semibold text-slate-500 hover:text-teal-600 transition-colors flex items-center gap-1 px-3 py-2 rounded-lg hover:bg-slate-50">
    ...
    <div class="max-w-5xl mx-auto px-4 py-8">
        ...
        <form action="<?php echo e(route('register')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6" onsubmit="handleAuthSubmit(event, 'register')">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-section-body space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" value="<?php echo e(date('Y')); ?> - <?php echo e(date('Y') + 1); ?>" readonly
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="psa_birth_cert_no" placeholder="XXX-XXXX-XXXXXX"
                                   value="<?php echo e(old('psa_birth_cert_no')); ?>"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div>
                            ...
                            <div class="flex gap-4 mt-2">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="gender" value="Male" class="custom-radio" <?php if(old('gender') == 'Male'): echo 'checked'; endif; ?> required>
                                    <span class="text-sm text-slate-600">Male</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="gender" value="Female" class="custom-radio" <?php if(old('gender') == 'Female'): echo 'checked'; endif; ?> required>
                        ...
                        <div class="flex items-start gap-4">
                            <div class="flex-1">
                                ...
                                <div class="flex gap-4 mt-1">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="is_ip" value="1" class="custom-radio" onchange="toggleIpField()" <?php if(old('is_ip') == '1'): echo 'checked'; endif; ?>>
                                        <span class="text-sm text-slate-600">Yes</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="is_ip" value="0" class="custom-radio" onchange="toggleIpField()" <?php if(old('is_ip') != '1'): echo 'checked'; endif; ?>>
                                        <span class="text-sm text-slate-600">No</span>
                                    </label>
                                </div>
                            </div>
                            <div class="flex-1" id="ipSpecificationField">
                                ...
                                <input type="text" name="ip_specification" placeholder="e.g., Subanon, Manobo"
                                       value="<?php echo e(old('ip_specification')); ?>"
                                       class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm"
                                       disabled>
                            </div>
                        </div>
                    ...
                    <div class="sub-section">
                        <div class="flex items-start gap-4">
                            <div class="flex-1">
                                ...
                                <div class="flex gap-4 mt-1">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="is_4ps_beneficiary" value="1" class="custom-radio" onchange="toggle4psField()" <?php if(old('is_4ps_beneficiary') == '1'): echo 'checked'; endif; ?>>
                                        <span class="text-sm text-slate-600">Yes</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="is_4ps_beneficiary" value="0" class="custom-radio" onchange="toggle4psField()" <?php if(old('is_4ps_beneficiary') != '1'): echo 'checked'; endif; ?>>
                                        <span class="text-sm text-slate-600">No</span>
                                    </label>
                                </div>
                            </div>
                            <div class="flex-1" id="householdIdField">
                                ...
                                <input type="text" name="household_id_4ps" placeholder="XXXXXXXXXXXX"
                                       value="<?php echo e(old('household_id_4ps')); ?>"
                                       class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm font-mono tracking-wider"
                                       disabled>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 sub-section">
                        <div>
                            ...
                            <input type="text" name="nationality" placeholder="FILIPINO" required
                                   value="<?php echo e(old('nationality', 'Filipino')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                        </div>
                        <div>
                            ...
                            <input type="text" name="religion" placeholder="ROMAN CATHOLIC" required
                                   value="<?php echo e(old('religion', 'Roman Catholic')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="street_name" placeholder="MABINI STREET"
                                   value="<?php echo e(old('street_name')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                        <div>
                            ...
                            <input type="text" name="permanent_city" placeholder="DAUIN"
                                   value="<?php echo e(old('permanent_city')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                        </div>
                        <div>
                            <label class="form-label">Province</label>
                            <input type="text" name="permanent_province" placeholder="NEGROS ORIENTAL"
                                   value="<?php echo e(old('permanent_province')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                        </div>
                        <div>
                            <label class="form-label">Country</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="permanent_zip_code" placeholder="6217" maxlength="4"
                                   value="<?php echo e(old('permanent_zip_code')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm font-mono">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                            <div>
                                ...
                                <input type="text" name="guardian_last_name" placeholder="DELA CRUZ"
                                       value="<?php echo e(old('guardian_last_name')); ?>"
                                       class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                            </div>
                            <div>
                                <label class="form-label">First Name</label>
                                <input type="text" name="guardian_first_name" placeholder="JUAN"
                                       value="<?php echo e(old('guardian_first_name')); ?>"
                                       class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                            </div>
                            <div>
                                <label class="form-label">Middle Name</label>
                                <input type="text" name="guardian_middle_name" placeholder="SANTOS"
                                       value="<?php echo e(old('guardian_middle_name')); ?>"
                                       class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                            </div>
                            <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="last_grade_level_completed" placeholder="Grade 3"
                                   value="<?php echo e(old('last_grade_level_completed')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                        </div>
                        <div>
                            ...
                            <input type="text" name="last_school_year_completed" placeholder="2024-2025"
                                   value="<?php echo e(old('last_school_year_completed')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="previous_school_id" placeholder="6-digit School ID"
                                   value="<?php echo e(old('previous_school_id')); ?>"
                                   class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm font-mono">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <select name="remarks" class="w-full px-3 py-2.5 border-2 border-slate-300 rounded focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 outline-none transition-all text-sm bg-white">
                                <option value="" <?php if(old('remarks') == ''): echo 'selected'; endif; ?>>-- Select Remark --</option>
            ...
            <div class="pt-4 pb-8">
                ...
                <p class="text-center text-sm text-slate-500 mt-4">
                    By submitting, you agree to our <a href="<?php echo e(route('landing')); ?>" class="text-teal-600 hover:underline font-medium">Terms of Service</a> and <a href="<?php echo e(route('landing')); ?>" class="text-teal-600 hover:underline font-medium">Privacy Policy</a>
                </p>
    ...
    <footer class="bg-slate-800 text-slate-400 py-6 border-t border-white/5">
        <div class="max-w-5xl mx-auto px-4 text-center">
            <p class="text-xs">© <?php echo e(date('Y')); ?> Tugawe Elementary School • Department of Education • All rights reserved</p>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views/auth/register-page.blade.php ENDPATH**/ ?>