...
<body class="bg-slate-50 text-slate-800 antialiased" x-data="{ mobileOpen: false }">
        ...
        <div class="glass-panel bg-red-50/90 border border-red-200/50 rounded-2xl p-4 shadow-2xl flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-red-700 mt-0.5 leading-relaxed">
                    <?php echo e(session('error') ?? 'Please check your input and try again.'); ?>
    ...
    <div class="lg:hidden fixed top-0 left-0 right-0 z-40 glass-panel border-b border-white/50 px-4 py-3 flex items-center justify-between">
        ...
        <div class="w-9 h-9 rounded-full gradient-bg flex items-center justify-center text-white font-bold text-sm avatar-glow">
            <?php echo e(substr(auth()->user()->first_name ?? 'T', 0, 1)); ?><?php echo e(substr(auth()->user()->last_name ?? 'P', 0, 1)); ?>
    ...
    <div class="flex h-screen overflow-hidden pt-14 lg:pt-0">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden lg:ml-72 relative">
            ...
            <main class="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar p-4 lg:p-6 xl:p-8 bg-gradient-to-br from-slate-50 via-white to-slate-100">
                ...
                <form id="settings-form" action="<?php echo e(route('teacher.settings.update')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div id="content-account" class="settings-section space-y-6">
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="flex flex-col md:flex-row gap-6 mb-6">
                                ...
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <a href="<?php echo e(route('teacher.profile.edit')); ?>" class="text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">
                                        Edit in Profile
                                    </a>
                                </div>
                                ...
                                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div class="space-y-2">
                                        ...
                                        <div class="px-4 py-3 rounded-xl bg-slate-100 text-sm font-semibold text-slate-800">
                                            <?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->middle_name); ?> <?php echo e(auth()->user()->last_name); ?> <?php echo e(auth()->user()->suffix); ?>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="px-4 py-3 rounded-xl bg-primary-100 text-sm font-bold text-primary-700 border border-primary-200 inline-flex items-center gap-2">
                                            ...
                                            <?php echo e(auth()->user()->role->name ?? 'Teacher'); ?>
                            ...
                            <div class="p-4 rounded-xl bg-amber-50 border border-amber-200 flex items-start gap-3">
                                ...
                                <p class="text-sm text-amber-800">
                                    To update your profile information (name, email, contact details), please use the <a href="<?php echo e(route('teacher.profile.edit')); ?>" class="font-semibold underline">Edit Profile</a> page.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    <div class="flex items-center gap-4">
                                        <div class="w-10 h-10 rounded-lg <?php echo e($session->is_current ? 'bg-emerald-100 text-emerald-600' : 'bg-slate-100 text-slate-600'); ?> flex items-center justify-center">
                                            <i class="fas <?php echo e($session->device_type == 'mobile' ? 'fa-mobile-alt' : ($session->device_type == 'tablet' ? 'fa-tablet-alt' : 'fa-laptop')); ?>"></i>
                                        </div>
                                        <div>
                                            <p class="font-semibold text-slate-800"><?php echo e($session->device_name); ?> <?php echo e($session->is_current ? '(Current)' : ''); ?></p>
                                            <p class="text-xs text-slate-500"><?php echo e($session->location); ?> • <?php echo e($session->last_active->diffForHumans()); ?></p>
                                        </div>
                                    </div>
                                    <?php if(!$session->is_current): ?>
                                    <form action="<?php echo e(route('teacher.settings.revoke-session', $session->id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="mt-4 pt-4 border-t border-slate-200">
                                <form action="<?php echo e(route('teacher.settings.revoke-all-sessions')); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                ...
                                <div class="toggle-switch <?php echo e(auth()->user()->two_factor_enabled ? 'active' : ''); ?>" onclick="toggle2FA(this)">
                                    <input type="hidden" name="two_factor_enabled" value="<?php echo e(auth()->user()->two_factor_enabled ? '1' : '0'); ?>">
                                </div>
                            </div>
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['email_notifications'] ?? true ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'email_notifications')">
                                        <input type="hidden" name="settings[email_notifications]" value="<?php echo e(auth()->user()->settings['email_notifications'] ?? true ? '1' : '0'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['attendance_alerts'] ?? true ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'attendance_alerts')">
                                        <input type="hidden" name="settings[attendance_alerts]" value="<?php echo e(auth()->user()->settings['attendance_alerts'] ?? true ? '1' : '0'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['grade_reminders'] ?? true ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'grade_reminders')">
                                        <input type="hidden" name="settings[grade_reminders]" value="<?php echo e(auth()->user()->settings['grade_reminders'] ?? true ? '1' : '0'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['new_student_notifications'] ?? false ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'new_student_notifications')">
                                        <input type="hidden" name="settings[new_student_notifications]" value="<?php echo e(auth()->user()->settings['new_student_notifications'] ?? false ? '1' : '0'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['system_updates'] ?? true ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'system_updates')">
                                        <input type="hidden" name="settings[system_updates]" value="<?php echo e(auth()->user()->settings['system_updates'] ?? true ? '1' : '0'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['sms_notifications'] ?? false ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'sms_notifications')">
                                        <input type="hidden" name="settings[sms_notifications]" value="<?php echo e(auth()->user()->settings['sms_notifications'] ?? false ? '1' : '0'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="space-y-2">
                                    ...
                                    <select name="settings[theme]" id="themeSelect"
                                        ...
                                        <option value="light" <?php echo e((auth()->user()->settings['theme'] ?? 'light') == 'light' ? 'selected' : ''); ?>>Light</option>
                                        <option value="dark" <?php echo e((auth()->user()->settings['theme'] ?? 'light') == 'dark' ? 'selected' : ''); ?>>Dark</option>
                                        <option value="system" <?php echo e((auth()->user()->settings['theme'] ?? 'light') == 'system' ? 'selected' : ''); ?>>System Default</option>
                                    </select>
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <select name="settings[language]" class="select-field w-full px-4 py-3 rounded-xl bg-white text-sm font-semibold text-slate-800 focus:outline-none">
                                        <option value="en" <?php echo e((auth()->user()->settings['language'] ?? 'en') == 'en' ? 'selected' : ''); ?>>English</option>
                                        <option value="fil" <?php echo e((auth()->user()->settings['language'] ?? 'en') == 'fil' ? 'selected' : ''); ?>>Filipino</option>
                                        <option value="ceb" <?php echo e((auth()->user()->settings['language'] ?? 'en') == 'ceb' ? 'selected' : ''); ?>>Cebuano</option>
                                    </select>
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <select name="settings[date_format]" class="select-field w-full px-4 py-3 rounded-xl bg-white text-sm font-semibold text-slate-800 focus:outline-none">
                                        <option value="MM/DD/YYYY" <?php echo e((auth()->user()->settings['date_format'] ?? 'MM/DD/YYYY') == 'MM/DD/YYYY' ? 'selected' : ''); ?>>MM/DD/YYYY</option>
                                        <option value="DD/MM/YYYY" <?php echo e((auth()->user()->settings['date_format'] ?? 'MM/DD/YYYY') == 'DD/MM/YYYY' ? 'selected' : ''); ?>>DD/MM/YYYY</option>
                                        <option value="YYYY-MM-DD" <?php echo e((auth()->user()->settings['date_format'] ?? 'MM/DD/YYYY') == 'YYYY-MM-DD' ? 'selected' : ''); ?>>YYYY-MM-DD</option>
                                    </select>
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <select name="settings[time_format]" class="select-field w-full px-4 py-3 rounded-xl bg-white text-sm font-semibold text-slate-800 focus:outline-none">
                                        <option value="12h" <?php echo e((auth()->user()->settings['time_format'] ?? '12h') == '12h' ? 'selected' : ''); ?>>12-hour (AM/PM)</option>
                                        <option value="24h" <?php echo e((auth()->user()->settings['time_format'] ?? '12h') == '24h' ? 'selected' : ''); ?>>24-hour</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="space-y-4">
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['profile_visible'] ?? true ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'profile_visible')">
                                        <input type="hidden" name="settings[profile_visible]" value="<?php echo e(auth()->user()->settings['profile_visible'] ?? true ? '1' : '0'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['email_visible_to_students'] ?? false ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'email_visible_to_students')">
                                        <input type="hidden" name="settings[email_visible_to_students]" value="<?php echo e(auth()->user()->settings['email_visible_to_students'] ?? false ? '1' : '0'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="setting-item flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <div class="toggle-switch <?php echo e(auth()->user()->settings['show_last_active'] ?? true ? 'active' : ''); ?>" onclick="this.classList.toggle('active'); updateSetting(this, 'show_last_active')">
                                        <input type="hidden" name="settings[show_last_active]" value="<?php echo e(auth()->user()->settings['show_last_active'] ?? true ? '1' : '0'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between p-4 rounded-xl bg-white/50 border border-slate-100">
                                    ...
                                    <a href="<?php echo e(route('teacher.settings.export-data')); ?>" class="px-4 py-2 rounded-lg bg-blue-100 text-blue-700 font-semibold text-sm hover:bg-blue-200 transition-colors border border-blue-200">
                                        Export
                                    </a>
                                </div>
                            </div>
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
        <div class="glass-panel bg-white rounded-3xl p-8 max-w-md w-full mx-4 shadow-2xl">
            ...
            <form action="<?php echo e(route('teacher.settings.delete-account')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\settings\index.blade.php ENDPATH**/ ?>