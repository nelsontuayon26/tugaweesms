...
<body class="bg-slate-50 text-slate-800 antialiased" x-data="{ mobileOpen: false }" @keydown.escape.window="mobileOpen = false">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500 font-medium flex items-center gap-2 mt-0.5">
                                ...
                                <?php echo e(($schoolYear ?? $activeSchoolYear)?->name ?? 'No School Year Selected'); ?>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="hidden md:flex items-center gap-3">
                            <div class="stat-pill">
                                ...
                                <span><?php echo e($students->count()); ?> Total</span>
                            </div>
                            <div class="stat-pill">
                                <i class="fas fa-user-check text-sm"></i>
                                <span><?php echo e($students->where('status', 'active')->count() ?? $students->count()); ?> Active</span>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex items-center gap-2 bg-white border border-slate-200 rounded-xl px-4 py-2 shadow-sm">
                            ...
                            <select class="bg-transparent border-none outline-none text-sm text-slate-700 cursor-pointer font-medium" onchange="updateFilter('school_year_id', this.value)">
                                <?php $allSchoolYears = \App\Models\SchoolYear::orderBy('start_date', 'desc')->get(); ?>
                                <?php $__currentLoopData = $allSchoolYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sy->id); ?>" <?php echo e(($schoolYear->id ?? $activeSchoolYear?->id) == $sy->id ? 'selected' : ''); ?>><?php echo e($sy->name); ?></option>
                        ...
                        <div class="flex items-center gap-2 bg-white border border-slate-200 rounded-xl px-4 py-2 shadow-sm">
                            ...
                            <select class="bg-transparent border-none outline-none text-sm text-slate-700 cursor-pointer font-medium" onchange="updateFilter('grade', this.value)">
                                ...
                                <?php $__currentLoopData = $allGrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($grade); ?>" <?php echo e(request('grade') == $grade ? 'selected' : ''); ?>>Grade <?php echo e($grade); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="flex items-center gap-2 bg-white border border-slate-200 rounded-xl px-4 py-2 shadow-sm">
                            ...
                            <select class="bg-transparent border-none outline-none text-sm text-slate-700 cursor-pointer font-medium" onchange="updateFilter('section', this.value)">
                                ...
                                <?php $__currentLoopData = $allSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($section); ?>" <?php echo e(request('section') == $section ? 'selected' : ''); ?>><?php echo e($section); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>

                        <?php if(request('grade') || request('section')): ?>
                            <a href="<?php echo e(route('admin.students.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium underline">
                                Clear Filters
                            </a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="p-6 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-50 to-white">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500">Showing all <?php echo e($students->count()); ?> enrolled pupils</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select class="bg-white border border-slate-200 rounded-lg px-3 py-1.5 text-sm font-medium text-slate-700 outline-none focus:border-blue-500" onchange="updateFilter('sort', this.value)">
                                <option value="" <?php echo e(request('sort') == '' || request('sort') == 'newest' ? 'selected' : ''); ?>>Newest First</option>
                                <option value="name" <?php echo e(request('sort') == 'name' ? 'selected' : ''); ?>>Name (A-Z)</option>
                                <option value="grade" <?php echo e(request('sort') == 'grade' ? 'selected' : ''); ?>>Grade Level</option>
                            </select>
                        </div>
                    </div>
    ...
    ?>
    <?php if((!request('sort') || request('sort') === 'newest') && $currentSection !== $sectionName): ?>
        <tr class="bg-slate-100 border-y border-slate-200">
            <td colspan="7" class="px-4 py-2">
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-bold text-slate-700 text-sm"><?php echo e($sectionName); ?></span>
                    <span class="text-xs text-slate-500">— <?php echo e($gradeLevelName); ?></span>
                </div>
            </td>
        </tr>
    ...
    <tr class="student-row"
        data-grade="<?php echo e($gradeLevelName); ?>"
        data-section="<?php echo e($sectionName); ?>"
        data-school-year="<?php echo e($schoolYear->name ?? $activeSchoolYear?->name ?? ''); ?>"
        data-status="<?php echo e($enrollment?->status ?? 'pending'); ?>"
        data-name="<?php echo e(strtolower($student->full_name)); ?>"
        data-lrn="<?php echo e(strtolower($student->lrn ?? '')); ?>"
        data-last-name="<?php echo e($student->user->last_name ?? ''); ?>"
        data-first-name="<?php echo e($student->user->first_name ?? ''); ?>"
        data-middle-name="<?php echo e($student->user->middle_name ?? ''); ?>"
        data-gender="<?php echo e($student->gender ?? ''); ?>"
        data-birthdate="<?php echo e($student->birthdate ?? ''); ?>"
        data-mother-tongue="<?php echo e($student->mother_tongue ?? ''); ?>"
        data-ethnicity="<?php echo e($student->ethnicity ?? ''); ?>"
        data-religion="<?php echo e($student->religion ?? ''); ?>"
        data-street="<?php echo e($student->street_address ?? ''); ?>"
        data-barangay="<?php echo e($student->barangay ?? ''); ?>"
        data-city="<?php echo e($student->city ?? ''); ?>"
        data-province="<?php echo e($student->province ?? ''); ?>"
        data-zip="<?php echo e($student->zip_code ?? ''); ?>"
        data-father="<?php echo e($student->father_name ?? ''); ?>"
        data-mother="<?php echo e($student->mother_name ?? ''); ?>"
        data-guardian="<?php echo e($student->guardian_name ?? ''); ?>"
        data-guardian-relationship="<?php echo e($student->guardian_relationship ?? ''); ?>"
        data-guardian-contact="<?php echo e($student->guardian_contact ?? ''); ?>"
        data-remarks="<?php echo e($student->remarks ?? ''); ?>"
    >
        <td>
            <input type="checkbox" class="custom-checkbox student-checkbox" value="<?php echo e($student->id); ?>" onchange="updateSelection()">
        </td>
        
        <!-- Student Information -->
        <td>
            <div class="flex items-center gap-3">
                <img src="<?php echo e($student->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($student->full_name) . '&background=random&color=fff&size=128'); ?>"
                     class="w-12 h-12 rounded-full border-2 border-white shadow-sm object-cover">
                <div>
                    <p class="font-bold text-slate-900 text-sm"><?php echo e($student->full_name); ?></p>
                    <p class="text-xs text-slate-500">ID: <?php echo e($student->id); ?> • LRN: <?php echo e($student->lrn ?? 'N/A'); ?></p>
                </div>
            </div>
        </td>
        ...
        <td>
            ...
            ?>
            <span class="status-badge <?php echo e($statusClass); ?> border capitalize">
                <i class="fas <?php echo e($statusIcon); ?> mr-1.5 text-[10px]"></i>
                <?php echo e($status); ?>
        ...
        <td class="text-right">
            <div class="flex items-center justify-end gap-1" x-data="{ idCardOpen: false }">
                <a href="<?php echo e(route('admin.students.show', $student)); ?>" class="action-btn text-blue-600 hover:bg-blue-50" title="View Details">
                    <i class="fas fa-eye"></i>
                </a>
                <button @click="idCardOpen = true" class="action-btn text-emerald-600 hover:bg-emerald-50" title="ID Card">
                    <i class="fas fa-id-card"></i>
                </button>
                <a href="<?php echo e(route('admin.students.edit', $student)); ?>" class="action-btn text-amber-600 hover:bg-amber-50" title="Edit">
                    <i class="fas fa-edit"></i>
                </a>
                <button onclick="deleteStudent(<?php echo e($student->id); ?>)" class="action-btn text-red-600 hover:bg-red-50" title="Delete">
    ...
    <tr>
        <td colspan="7" class="text-center py-16">
            ...
            <a href="<?php echo e(route('admin.students.create')); ?>" class="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30">
    ...
    <?php endif; ?>
                    ...
                    <div class="px-6 py-4 border-t border-slate-200 bg-slate-50/50 flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-semibold text-slate-900"><?php echo e($students->count()); ?></span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8 animate-fade-in-up" style="animation-delay: 0.2s;">
                    ...
                    <div class="glass-card p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-slate-900"><?php echo e($genderDistribution['Male'] ?? 0); ?></p>
                    ...
                    <div class="glass-card p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-slate-900"><?php echo e($genderDistribution['Female'] ?? 0); ?></p>
                    ...
                    <div class="glass-card p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-slate-900"><?php echo e($students->where('created_at', '>=', now()->subDays(7))->count()); ?></p>
                    ...
                    <div class="glass-card p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-2xl font-bold text-slate-900"><?php echo e($students->pluck('section')->unique()->count()); ?></p>
    ...
    <div id="bulkDeleteModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl shadow-2xl p-6 w-96">
            ...
            <div class="flex gap-3">
                ...
                <form id="bulkDeleteForm" method="POST" action="<?php echo e(route('admin.students.bulk-destroy')); ?>" class="flex-1">
                    <?php echo csrf_field(); ?>
...
document.getElementById('searchInput')?.addEventListener('input', function(e) {
    ...
    rows.forEach(row => {
        ...
        function submitExportForm(ids) {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("admin.students.export-csv")); ?>';
...
<a href="<?php echo e(route('admin.students.create')); ?>" class="fab-student">
    <i class="fas fa-plus text-xl"></i>
</a>


</body>
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\students\index.blade.php ENDPATH**/ ?>