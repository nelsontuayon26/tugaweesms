            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 animate-fade-in">
                <div class="stat-card">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-slate-900"><?php echo e($stats['total']); ?></span>
                    </div>
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-slate-900"><?php echo e($stats['teachers']); ?></span>
                    </div>
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-slate-900"><?php echo e($stats['sections']); ?></span>
                    </div>
            ...
            <div class="glass-card p-6 mb-6 animate-fade-in stagger-1">
                    ...
                    <div>
                        ...
                        <?php if($selectedSchoolYear): ?>
                            <span class="badge badge-emerald mt-2">
                                ...
                                <?php echo e($selectedSchoolYear->name); ?>
                ...
                <div :class="formOpen ? 'open' : ''" class="collapse-section">
                    <div class="border-t border-slate-100 pt-6 mt-4">
                        ...
                        <form action="<?php echo e(route('admin.teacher-subject-assignments.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($t->id); ?>" <?php echo e(old('teacher_id') == $t->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="section_id" class="form-select <?php $__errorArgs = ['section_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($s->id); ?>" <?php echo e(old('section_id') == $s->id ? 'selected' : ''); ?>>
                                                <?php echo e($s->name); ?> (<?php echo e($s->gradeLevel?->name ?? 'N/A'); ?>) — <?php echo e($s->schoolYear?->name ?? ''); ?>

                                                <?php if($s->teacher): ?> [Adviser: <?php echo e($s->teacher->full_name); ?>] <?php endif; ?>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sub->id); ?>" <?php echo e(old('subject_id') == $sub->id ? 'selected' : ''); ?>>
                                                <?php echo e($sub->name); ?> (<?php echo e($sub->gradeLevel?->name ?? 'All Grades'); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="school_year" class="form-select">
                                        ...
                                        <?php $__currentLoopData = $schoolYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sy->name); ?>" <?php echo e(old('school_year', $selectedSchoolYear?->name) == $sy->name ? 'selected' : ''); ?>>
                                                <?php echo e($sy->name); ?> <?php echo e($sy->is_active ? '★' : ''); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="schedule" class="form-input" value="<?php echo e(old('schedule')); ?>" placeholder="MWF, TTh, etc.">
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Room</label>
                                    <input type="text" name="room" class="form-input" value="<?php echo e(old('room')); ?>" placeholder="Room number">
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Time Start</label>
                                    <input type="time" name="time_start" class="form-input" value="<?php echo e(old('time_start')); ?>">
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Time End</label>
                                    <input type="time" name="time_end" class="form-input" value="<?php echo e(old('time_end')); ?>">
                                </div>
                            </div>
                ...
                <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between mt-6 pt-6 border-t border-slate-100">
                    <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                        <form action="<?php echo e(route('admin.teacher-subject-assignments.index')); ?>" method="GET" class="relative w-full sm:w-auto">
                            <i class="fas fa-search absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search assignments..." class="search-input">
                        </form>

                        <form action="<?php echo e(route('admin.teacher-subject-assignments.index')); ?>" method="GET" id="syFilterForm" class="relative w-full sm:w-auto">
                            <?php $__currentLoopData = ['search','teacher_id','section_id','subject_id']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $param): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(request($param)): ?><input type="hidden" name="<?php echo e($param); ?>" value="<?php echo e(request($param)); ?>"><?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <select name="school_year_id" onchange="document.getElementById('syFilterForm').submit()" class="form-select w-full sm:w-52">
                                <option value="">All School Years</option>
                                <?php $__currentLoopData = $schoolYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sy->id); ?>" <?php echo e($selectedSchoolYear && $selectedSchoolYear->id == $sy->id ? 'selected' : ''); ?>>
                                        <?php echo e($sy->name); ?> <?php echo e($sy->is_active ? '★ Active' : ''); ?>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <form action="<?php echo e(route('admin.teacher-subject-assignments.index')); ?>" method="GET" class="flex flex-wrap gap-2">
                            <?php if(request('search')): ?><input type="hidden" name="search" value="<?php echo e(request('search')); ?>"><?php endif; ?>
                            <?php if(request('school_year_id')): ?><input type="hidden" name="school_year_id" value="<?php echo e(request('school_year_id')); ?>"><?php endif; ?>

                            <select name="teacher_id" onchange="this.form.submit()" class="form-select w-auto min-w-[140px]">
                                <option value="">All Teachers</option>
                                <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($t->id); ?>" <?php echo e(request('teacher_id') == $t->id ? 'selected' : ''); ?>><?php echo e($t->full_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            ...
                            <select name="section_id" onchange="this.form.submit()" class="form-select w-auto min-w-[140px]">
                                ...
                                <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>" <?php echo e(request('section_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            ...
                            <select name="subject_id" onchange="this.form.submit()" class="form-select w-auto min-w-[140px]">
                                ...
                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sub->id); ?>" <?php echo e(request('subject_id') == $sub->id ? 'selected' : ''); ?>><?php echo e($sub->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>

                            <?php if(request('teacher_id') || request('section_id') || request('subject_id') || request('search') || request('school_year_id')): ?>
                                <a href="<?php echo e(route('admin.teacher-subject-assignments.index')); ?>" class="btn-secondary">
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="font-semibold text-slate-800 text-sm"><?php echo e($assignment->teacher_name); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge badge-indigo"><?php echo e($assignment->subject_name); ?></span>
                                        <?php if($assignment->subject_code): ?>
                                            <span class="text-xs text-slate-400 ml-1">(<?php echo e($assignment->subject_code); ?>)</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <span class="badge badge-emerald"><?php echo e($assignment->section_name ?? 'N/A'); ?></span>
                                    </td>
                                    <td>
                                        <span class="text-sm text-slate-600"><?php echo e($assignment->grade_level_name ?? 'N/A'); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge badge-slate"><?php echo e($assignment->school_year ?? 'N/A'); ?></span>
                                    </td>
                                    <td>
                                        <div class="text-sm text-slate-600">
                                            <?php if($assignment->schedule): ?>
                                                <div class="font-medium"><?php echo e($assignment->schedule); ?></div>
                                            <?php endif; ?>
                                            <?php if($assignment->time_start && $assignment->time_end): ?>
                                                <div class="text-xs text-slate-400"><?php echo e(date('g:i A', strtotime($assignment->time_start))); ?> - <?php echo e(date('g:i A', strtotime($assignment->time_end))); ?></div>
                                            <?php endif; ?>
                                            <?php if($assignment->room): ?>
                                                <div class="text-xs text-slate-400"><i class="fas fa-door-open mr-1"></i><?php echo e($assignment->room); ?></div>
                                            <?php endif; ?>
                                            <?php if(!$assignment->schedule && !$assignment->time_start && !$assignment->room): ?>
                                                <span class="text-slate-400 text-xs">—</span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <form action="<?php echo e(route('admin.teacher-subject-assignments.destroy', $assignment->id)); ?>" method="POST" onsubmit="return confirm('Remove this assignment? The teacher will no longer be able to encode grades for this subject.');">
                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\teacher-subject-assignments\index.blade.php ENDPATH**/ ?>