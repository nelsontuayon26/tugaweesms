...
<body class="bg-slate-50 min-h-screen">
            ...
            <div class="mb-6">
                <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="font-medium text-green-800">Logged in as <?php echo e(auth()->user()->first_name); ?></p>
    ...
    <script>
        async function testBiometricAuth() {
            ...
            try {
                const result = await window.authenticateWithBiometric('<?php echo e(auth()->user()->username ?? ''); ?>');
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\biometric-demo.blade.php ENDPATH**/ ?>