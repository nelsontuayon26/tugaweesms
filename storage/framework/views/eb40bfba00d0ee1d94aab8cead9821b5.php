...
<body class="bg-gradient-to-br from-red-50 to-orange-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full text-center">
        ...
        <p class="text-gray-600 mb-6"><?php echo e($message ?? 'This QR code is invalid or has expired.'); ?></p>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\enrollment\invalid.blade.php ENDPATH**/ ?>