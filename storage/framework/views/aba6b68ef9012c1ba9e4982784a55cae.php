<?php $__env->startSection('title', 'Parent Communications'); ?>
    ...
    <div class="grid grid-cols-4 gap-4 mb-6">
        <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($unreadCount ?? 0); ?></p>
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($sentCount ?? 0); ?></p>
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($parentCount ?? 0); ?></p>
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($announcementCount ?? 0); ?></p>
    ...
    <div x-show="showCompose" x-cloak class="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative bg-white rounded-2xl shadow-xl max-w-2xl w-full p-6">
                ...
                <form action="<?php echo e(route('teacher.communications.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="recipient_ids[]" multiple required
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $sections ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <?php if($validEnrollments->isNotEmpty()): ?>
                                        <optgroup label="<?php echo e($section->name); ?>">
                                            <?php $__currentLoopData = $validEnrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($enrollment->student->user_id); ?>">
                                                    <?php echo e($enrollment->student->full_name); ?> (Parent)
                                                </option>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200">
        ...
        <div class="divide-y divide-slate-100">
            <?php $__empty_1 = true; $__currentLoopData = $messages ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('teacher.communications.show', $message)); ?>" 
                   class="flex items-center gap-4 p-4 hover:bg-slate-50 transition-colors <?php echo e($message->read_at ? '' : 'bg-indigo-50/50'); ?>">
                    <div class="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold">
                        <?php echo e(substr($message->sender->first_name ?? 'U', 0, 1)); ?>

                    </div>
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2">
                            <span class="font-semibold text-slate-800"><?php echo e($message->sender->name ?? 'Unknown'); ?></span>
                            <?php if(!$message->read_at): ?>
                                <span class="px-2 py-0.5 bg-indigo-500 text-white text-xs rounded-full">New</span>
                            <?php endif; ?>
                        </div>
                        <p class="text-sm text-slate-600 truncate"><?php echo e($message->subject); ?></p>
                        <p class="text-xs text-slate-400"><?php echo e($message->created_at->diffForHumans()); ?></p>
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\communications\index.blade.php ENDPATH**/ ?>