        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center h-20">
                <a href="#" class="flex items-center gap-3 group">
                    <div class="relative">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-12 w-12 rounded-xl object-cover shadow-lg group-hover:scale-105 transition-transform">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="max-w-2xl">
                   ...
                   <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-12 pt-8 border-t border-slate-200/60">
                        <div>
                            <p class="text-3xl font-bold text-teal-600"><?php echo e($studentCount); ?>+</p>
                            <p class="text-sm text-slate-500 font-medium">Students</p>
                        </div>
                        <div>
                            <p class="text-3xl font-bold text-orange-500"><?php echo e($teachers->count()); ?>+</p>
                            <p class="text-sm text-slate-500 font-medium">Teachers</p>
                        </div>
                        <div>
                            <p class="text-3xl font-bold text-teal-600"><?php echo e($sectionCount); ?></p>
...
function imageSlider() {
    return {
        slides: [
            '<?php echo e(asset("images/tes2.jpg")); ?>',
            '<?php echo e(asset("images/tes1.jpg")); ?>',
            '<?php echo e(asset("images/tes3.jpg")); ?>',
            '<?php echo e(asset("images/tes4.jpg")); ?>',
            '<?php echo e(asset("images/tes5.jpg")); ?>',
            '<?php echo e(asset("images/tes6.jpg")); ?>',
            '<?php echo e(asset("images/tes7.jpg")); ?>',
            '<?php echo e(asset("images/tes8.jpg")); ?>',
            '<?php echo e(asset("images/tes11.jpg")); ?>',
            '<?php echo e(asset("images/tes12.jpg")); ?>',
            '<?php echo e(asset("images/tes13.jpg")); ?>',
            '<?php echo e(asset("images/tes14.jpg")); ?>',
...
<section id="about" class="py-24 bg-white relative overflow-hidden">
                ...
                <article class="bg-white rounded-2xl p-6 card-hover border border-slate-100 relative overflow-hidden group">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <time class="text-sm font-semibold text-slate-400">
                            <?php echo e($announcement->created_at->format('F d, Y')); ?>
                    ...
                    <div class="flex items-center gap-3 pt-4 border-t border-slate-100">
                        <div class="w-10 h-10 rounded-full bg-gradient-to-br from-teal-100 to-teal-200 flex items-center justify-center text-sm font-bold text-teal-700">
                            <?php echo e($announcement->author ? substr($announcement->author->full_name ?? $announcement->author->name ?? 'A', 0, 1) : 'A'); ?>
                        ...
                        <div>
                            ...
                            ?>
                            <span class="text-sm font-semibold text-slate-900 block"><?php echo e($authorName); ?></span>
                            <span class="text-xs text-slate-500"><?php echo e($authorRole); ?></span>
                        </div>
                    </div>
                </article>
    ...
    <section id="faculty" class="py-24 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div class="text-center group">
                    <div class="relative inline-block mb-6">
                        ...
                        <div class="relative w-40 h-40 mx-auto rounded-3xl overflow-hidden bg-slate-100 shadow-2xl border-4 border-white">
                            <img src="<?php echo e($principal->user?->photo ? profile_photo_url($principal->user->photo) : asset('images/photo-placeholder.png')); ?>" 
                                 alt="<?php echo e($principal->first_name); ?> <?php echo e($principal->last_name); ?>"
                    ...
                    <h3 class="text-2xl font-bold text-slate-900 mb-1"><?php echo e($principal->first_name); ?> <?php echo e($principal->last_name); ?></h3>
            ...
            <?php if($teachingStaff->count()): ?>
         <div class="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
                <?php $__currentLoopData = $teachingStaff->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center group">
                    <div class="relative mb-4 mx-auto w-24 h-24">
                        ...
                        <div class="relative w-24 h-24 mx-auto rounded-2xl overflow-hidden bg-slate-100 shadow-lg border-2 border-white">
                            <img src="<?php echo e($teacher->user?->photo ? profile_photo_url($teacher->user->photo) : asset('images/photo-placeholder.png')); ?>"
                                 alt="<?php echo e($teacher->first_name); ?> <?php echo e($teacher->last_name); ?>"
                    ...
                    ?>
                    <?php if($teacherGradeLevels->count()): ?>
                        <p class="text-[10px] text-slate-500">
                            <?php echo e($teacherGradeLevels->implode(', ')); ?>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="flex items-center gap-4">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" class="h-10 w-10 rounded-lg object-cover opacity-80 ring-2 ring-teal-500/30">
                    <div>
                ...
                <p class="text-xs text-slate-600">
                    © <?php echo e(date('Y')); ?> Department of Education. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
    ...
    <div id="authSidePanel" class="side-panel">
        <div class="min-h-full flex flex-col bg-gradient-to-b from-slate-50/50 to-white">
            ...
            <div class="p-6 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <div class="flex items-center gap-3">
                    <div class="relative">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" class="h-10 w-10 rounded-xl object-cover shadow-md ring-2 ring-teal-100">
            ...
            <div class="flex-1 p-6 relative overflow-hidden">
                ...
                <div id="loginForm" class="form-slide active space-y-5">
                    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5" onsubmit="handleAuthSubmit(event, 'login')">
                        <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('register')); ?>" method="POST" enctype="multipart/form-data" class="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden" onsubmit="handleAuthSubmit(event, 'register')">
    <?php echo csrf_field(); ?>
    ...
    <div class="p-8 space-y-8">
                ...
                <div>
                    ...
                    <select name="grade_level_id" required
                        ...
                        <?php $__currentLoopData = $gradeLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($level->id); ?>" <?php if(old('grade_level_id') == $level->id): echo 'selected'; endif; ?>><?php echo e($level->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="type" id="studentType" required onchange="toggleStudentTypeFields()"
                            class="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all bg-white">
                        <option value="new" <?php if(old('type') == 'new' || old('type') === null): echo 'selected'; endif; ?>>New Pupil</option>
                        <option value="transferee" <?php if(old('type') == 'transferee'): echo 'selected'; endif; ?>>Transferee</option>
                        <option value="continuing" <?php if(old('type') == 'continuing'): echo 'selected'; endif; ?>>Continuing</option>
                    </select>
                </div>
            </div>
        ...
        <div class="bg-slate-50 p-6 rounded-xl border border-slate-200">
            ...
            <div id="lrnNewField" class="<?php echo e(old('type') === 'transferee' ? 'hidden' : ''); ?>">
            ...
            <div id="lrnExistingField" class="<?php echo e(old('type') === 'transferee' ? '' : 'hidden'); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="suffix" class="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all bg-white">
                        <option value="" <?php if(old('suffix') == ''): echo 'selected'; endif; ?>>None</option>
                        <option value="Jr." <?php if(old('suffix') == 'Jr.'): echo 'selected'; endif; ?>>Jr.</option>
                        <option value="Sr." <?php if(old('suffix') == 'Sr.'): echo 'selected'; endif; ?>>Sr.</option>
                        <option value="II" <?php if(old('suffix') == 'II'): echo 'selected'; endif; ?>>II</option>
                        <option value="III" <?php if(old('suffix') == 'III'): echo 'selected'; endif; ?>>III</option>
                        <option value="IV" <?php if(old('suffix') == 'IV'): echo 'selected'; endif; ?>>IV</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="ethnicity" placeholder="e.g., Cebuano, Tagalog" required
                           value="<?php echo e(old('ethnicity')); ?>"
                           class="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all">
                </div>
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="mother_tongue" placeholder="e.g., Cebuano, Filipino" required
                           value="<?php echo e(old('mother_tongue')); ?>"
                           class="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all">
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="guardian_relationship" required
                        ...
                        <option value="Parent" <?php if(old('guardian_relationship') == 'Parent'): echo 'selected'; endif; ?>>Parent</option>
                        <option value="Grandparent" <?php if(old('guardian_relationship') == 'Grandparent'): echo 'selected'; endif; ?>>Grandparent</option>
                        <option value="Sibling" <?php if(old('guardian_relationship') == 'Sibling'): echo 'selected'; endif; ?>>Sibling</option>
                        <option value="Relative" <?php if(old('guardian_relationship') == 'Relative'): echo 'selected'; endif; ?>>Relative</option>
                        <option value="Other" <?php if(old('guardian_relationship') == 'Other'): echo 'selected'; endif; ?>>Other</option>
                    </select>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="remarks" class="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all bg-white">
                        <option value="" <?php if(old('remarks') == ''): echo 'selected'; endif; ?>>-- Select Remark (Optional) --</option>
                        <option value="TI" <?php if(old('remarks') == 'TI'): echo 'selected'; endif; ?>>TI - Transferred In</option>
                        <option value="TO" <?php if(old('remarks') == 'TO'): echo 'selected'; endif; ?>>TO - Transferred Out</option>
                        <option value="DO" <?php if(old('remarks') == 'DO'): echo 'selected'; endif; ?>>DO - Dropped Out</option>
                        <option value="LE" <?php if(old('remarks') == 'LE'): echo 'selected'; endif; ?>>LE - Late Enrollee</option>
                        <option value="CCT" <?php if(old('remarks') == 'CCT'): echo 'selected'; endif; ?>>CCT - CCT Recipient</option>
                        <option value="BA" <?php if(old('remarks') == 'BA'): echo 'selected'; endif; ?>>BA - Balik Aral</option>
                        <option value="LWD" <?php if(old('remarks') == 'LWD'): echo 'selected'; endif; ?>>LWD - Learner With Disability</option>
                    </select>
                </div>
            ...
            <div class="bg-white w-full max-w-3xl max-h-[85vh] overflow-y-auto rounded-3xl shadow-2xl">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <article class="pb-6 border-b border-slate-100 last:border-0 hover:bg-slate-50 p-4 rounded-xl transition-colors">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 mb-2"><?php echo e($announcement->title); ?></h3>
                        <p class="text-slate-600 leading-relaxed"><?php echo e($announcement->message); ?></p>
                        <div class="mt-4 flex items-center gap-2">
                            ...
                            ?>
                            <span class="text-sm text-slate-500">Posted by <span class="font-semibold text-slate-700"><?php echo e($authorName2); ?></span> <span class="text-slate-400">· <?php echo e($authorRole2); ?></span></span>
                        </div>
                    </article>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="bg-white w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl">
                ...
                <div class="p-8 space-y-12">
                    ...
                    <div class="text-center pb-12 border-b border-slate-100">
                        ...
                        <h3 class="text-2xl font-bold text-slate-900"><?php echo e($principal->first_name); ?> <?php echo e($principal->last_name); ?></h3>
                        <p class="text-teal-600 font-semibold">School Principal</p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                            <?php $__currentLoopData = $teachingStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="text-center group">
                                ...
                                <h5 class="text-sm font-bold text-slate-900 mb-1"><?php echo e($teacher->first_name); ?> <?php echo e($teacher->last_name); ?></h5>
                                <p class="text-xs text-teal-600 font-semibold bg-teal-50 px-2 py-0.5 rounded-full inline-block mb-1"><?php echo e($teacher->position ?? 'Teacher'); ?></p>
                                <?php
                                    $teacherGradeLevels = $teacher->sections->pluck('gradeLevel.name')->filter()->unique()->values();
                                ?>
                                <?php if($teacherGradeLevels->count()): ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <script>
        ...
        Swal.fire({
            ...
            text: "<?php echo e(session('error') ?? $errors->first('error')); ?>",
...
<?php if($hasRegistrationErrors || session('panel_mode') === 'register'): ?>
<script>
document.addEventListener('DOMContentLoaded', function() {
    playErrorSound();
...
<?php if(session('pending_approval')): ?>
<script>
document.addEventListener('DOMContentLoaded', function() {
...
async function submitForgotPassword() {
    ...
    try {
        const response = await fetch('<?php echo e(route('password.email')); ?>', {
            method: 'POST',
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\auth\login.blade.php ENDPATH**/ ?>