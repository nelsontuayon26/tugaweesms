    ...
    <main class="py-12 px-4">
        <div class="max-w-xl mx-auto">
            ...
            <div class="glass rounded-3xl shadow-2xl p-8">
                <form action="<?php echo e(route('enrollment.check.status')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div class="glass rounded-3xl shadow-2xl p-8">
                ...
                <div class="bg-slate-50 rounded-xl p-6 mb-6">
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span class="font-semibold ml-1"><?php echo e($application->application_number); ?></span>
                        </div>
                        <div>
                            <span class="text-slate-500">Student:</span>
                            <span class="font-semibold ml-1"><?php echo e($application->student_full_name); ?></span>
                        </div>
                        <div>
                            <span class="text-slate-500">Grade Level:</span>
                            <span class="font-semibold ml-1"><?php echo e($application->gradeLevel->name ?? 'N/A'); ?></span>
                        </div>
                        <div>
                            <span class="text-slate-500">Submitted:</span>
                            <span class="font-semibold ml-1"><?php echo e($application->created_at->format('M d, Y')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('enrollment.check')); ?>" class="block w-full py-3 bg-slate-100 text-slate-700 font-semibold rounded-xl hover:bg-slate-200 transition-colors text-center">
            ...
            <div class="text-center mt-6">
                <a href="<?php echo e(route('enrollment.form')); ?>" class="text-white/80 hover:text-white text-sm">
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\enrollment\check.blade.php ENDPATH**/ ?>