...
<body class="bg-slate-100 min-h-screen" x-data="{ mobileOpen: false }" @keydown.escape.window="mobileOpen = false">
    ...
    <div class="lg:ml-72 p-6">
        ...
        <div class="mb-4 flex items-center justify-between no-print">
            ...
            <div class="flex gap-3">
                <div class="px-4 py-2 rounded-lg bg-indigo-50 border border-indigo-200 text-indigo-700 text-sm font-medium">
                    <i class="fas fa-calendar-alt mr-2"></i><?php echo e($activeSchoolYear?->name ?? now()->format('Y')); ?>
        ...
        <div class="no-print mb-4 bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <form method="GET" action="<?php echo e(route('teacher.sf4')); ?>" class="flex items-end gap-4">
                <div class="flex-1">
        ...
        <?php if($attendanceSummary->isEmpty() && $selectedSection): ?>
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center no-print mb-4">
                ...
                <p class="text-blue-800 font-medium">No enrolled students found for <?php echo e($selectedSection->name); ?> in <?php echo e($activeSchoolYear?->name ?? 'this school year'); ?></p>
                ...
                <tbody>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $maleData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="font-bold <?php echo e($data['attendance_rate'] >= 90 ? 'text-emerald-600' : ($data['attendance_rate'] >= 75 ? 'text-amber-600' : 'text-rose-600')); ?> text-[9px]">
                                <?php echo e($data['attendance_rate']); ?>%
                            </td>
                    ...
                    <tr class="bg-gray-200 font-bold border-t-2 border-black">
                        ...
                        <td class="text-[9px] border-b-2 border-black">
                            <?php echo e(number_format($monthlyStats['overall_avg_attendance'] ?? 0, 1)); ?>%
                        </td>
                    ...
                    <div class="summary-box bg-gray-50">
                        ...
                        <div class="space-y-1 text-[8px]">
                            <div class="flex justify-between border-b border-gray-300 pb-1">
                                ...
                                <span class="font-bold"><?php echo e($monthlyStats['total_school_days'] ?? 0); ?></span>
                            </div>
                            <div class="flex justify-between border-b border-gray-300 pb-1">
                                <span>Total Enrolled Students:</span>
                                <span class="font-bold"><?php echo e($monthlyStats['total_students'] ?? 0); ?></span>
                            </div>
                            <div class="flex justify-between border-b border-gray-300 pb-1">
                                <span>Male Students:</span>
                                <span class="font-bold"><?php echo e($monthlyStats['male_count'] ?? 0); ?></span>
                            </div>
                            <div class="flex justify-between border-b border-gray-300 pb-1">
                                <span>Female Students:</span>
                                <span class="font-bold"><?php echo e($monthlyStats['female_count'] ?? 0); ?></span>
                            </div>
                            <div class="flex justify-between pt-1">
                                <span>Overall Attendance Rate:</span>
                                <span class="font-bold <?php echo e(($monthlyStats['overall_avg_attendance'] ?? 0) >= 90 ? 'text-emerald-600' : 'text-amber-600'); ?>">
                                    <?php echo e(number_format($monthlyStats['overall_avg_attendance'] ?? 0, 1)); ?>%
                                </span>
                            </div>
                        </div>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\school-forms\sf4.blade.php ENDPATH**/ ?>