            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        ...
                        <?php $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route($form['route'])); ?>" class="report-card block">
                                <div class="icon-box <?php echo e($form['color']); ?>">
                                    <i class="fas <?php echo e($form['icon']); ?>"></i>
                                </div>
                                <h3 class="font-semibold text-slate-800 text-sm"><?php echo e($form['label']); ?></h3>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <a href="<?php echo e(route('teacher.reports.class-record')); ?>" class="report-card block">
                        ...
                        <a href="<?php echo e(route('teacher.attendance.monthly')); ?>" class="report-card block">
                        ...
                        <a href="<?php echo e(route('teacher.exports.sf1')); ?>" class="report-card block">
                        ...
                        <a href="<?php echo e(route('teacher.exports.sf9')); ?>" class="report-card block">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <a href="<?php echo e(route('teacher.sections.index')); ?>" class="report-card block">
                        ...
                        <a href="<?php echo e(route('teacher.grades.index')); ?>" class="report-card block">
                        ...
                        <a href="<?php echo e(route('teacher.attendance.index')); ?>" class="report-card block">
...
<?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\reports\index.blade.php ENDPATH**/ ?>