        ...
        <div class="main-wrapper">
            <div class="main-content">
                <div class="max-w-6xl mx-auto pb-32">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-amber-100 mt-1">Update <?php echo e($section->name); ?> information</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-6 text-sm text-amber-100 mt-6">
                                <span class="flex items-center gap-2">
                                    <i class="fas fa-history"></i>
                                    Created <?php echo e($section->created_at->diffForHumans()); ?>

                                </span>
                                <span class="flex items-center gap-2">
                                    <i class="fas fa-users"></i>
                                    <?php echo e($section->students->count()); ?> students enrolled
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="<?php echo e(route('admin.sections.update', $section)); ?>" method="POST" class="space-y-6" id="sectionForm">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="input-group">
                                        <label class="form-label">
                                            ...
                                            <span class="current-badge">
                                                ...
                                                <?php echo e($section->gradeLevel->name ?? 'None'); ?>
                                        ...
                                        <select name="grade_level_id" required class="form-select">
                                            ...
                                            <?php $__currentLoopData = $gradeLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($grade->id); ?>" <?php echo e(old('grade_level_id', $section->grade_level_id) == $grade->id ? 'selected' : ''); ?>>
                                                    <?php echo e($grade->name); ?> (Grade <?php echo e($grade->level); ?>)
                                                </option>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            <p class="error-message"><i class="fas fa-exclamation-triangle"></i> <?php echo e($message); ?></p>
                                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-group">
                                        <label class="form-label">
                                            ...
                                            <span class="current-badge">
                                                ...
                                                <?php echo e($section->schoolYear->name ?? 'None'); ?>
                                        ...
                                        <select name="school_year_id" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $schoolYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($year->id); ?>" <?php echo e(old('school_year_id', $section->school_year_id) == $year->id ? 'selected' : ''); ?>>
                                                    <?php echo e($year->name); ?> <?php echo e($year->is_active ? '(Active)' : ''); ?>

                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['school_year_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="glass-card p-8 rounded-3xl animate-fade-in stagger-2 bg-gradient-to-br from-amber-50/50 to-orange-50/50 border-amber-200/50">
                            ...
                            <div class="input-group">
                                <label class="form-label">
                                    ...
                                    <span class="current-badge">
                                        <i class="fas fa-user-tie"></i>
                                        <?php echo e($section->teacher->full_name ?? 'None'); ?>
                                ...
                                <select name="teacher_id" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('teacher_id', $section->teacher_id) == $teacher->id ? 'selected' : ''); ?>>
                                ...
                                <div class="input-group">
                                    <label class="form-label">
                                        ...
                                        <span class="current-badge">
                                            ...
                                            <?php echo e($section->room_number ?? 'None'); ?>

                                        </span>
                                    </label>
                                    <i class="fas fa-door-open input-icon"></i>
                                    <input type="text" name="room_number" 
                                           value="<?php echo e(old('room_number', $section->room_number)); ?>"
                                           class="form-input">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    <label class="form-label">
                                        ...
                                        <span class="current-badge">
                                            <i class="fas fa-users"></i>
                                            <?php echo e($section->capacity ?? 'None'); ?>
                        ...
                        <div class="sticky-footer">
                           <div class="max-w-6xl mx-auto flex items-center justify-between">
                                <div class="hidden md:flex items-center gap-3 text-sm text-slate-500">
                                    ...
                                    <span>Editing <?php echo e($section->name); ?></span>
                                </div>
                                <div class="flex gap-3 ml-auto">
                                    <a href="<?php echo e(route('admin.sections.index')); ?>" class="btn-secondary">                                        Cancel
                                    </a>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\admin\sections\edit.blade.php ENDPATH**/ ?>