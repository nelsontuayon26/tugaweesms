<?php $__env->startSection('title', 'Sections Overview'); ?>
            ...
            <div class="p-card p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-stone-900"><?php echo e($sections->total()); ?></p>
                    </div>
            ...
            <div class="p-card p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-stone-900"><?php echo e($selectedSchoolYear?->name ?? $activeSchoolYear?->name ?? 'N/A'); ?></p>
                    </div>
            ...
            <div class="p-card p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-stone-900"><?php echo e($totalStudents ?? 0); ?></p>
                    </div>
        ...
        <div class="p-card overflow-hidden">
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-stone-900 text-sm"><?php echo e($section->name); ?></p>
                                            <p class="text-[10px] text-stone-400"><?php echo e($section->students_count ?? 0); ?> pupils</p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="text-sm text-stone-600">
                                        <?php echo e($section->teacher?->first_name); ?> <?php echo e($section->teacher?->last_name ?? 'Unassigned'); ?>

                                    </span>
                                </td>
                                <td>
                                    <span class="font-mono text-xs text-stone-500 bg-stone-50 px-2 py-0.5 rounded border border-stone-200"><?php echo e($section->room_number ?? 'N/A'); ?></span>
                                </td>
                                <td>
                                    <span class="text-sm text-stone-600"><?php echo e($section->schoolYear?->name ?? 'N/A'); ?></span>
                                </td>
                            </tr>
            ...
            <?php if($sections->hasPages()): ?>
                <div class="px-5 py-4 border-t border-stone-100 bg-stone-50/50">
                    <div class="flex items-center justify-between">
                        <p class="text-xs text-stone-500">Showing <strong class="text-stone-900"><?php echo e($sections->firstItem() ?? 0); ?>-<?php echo e($sections->lastItem() ?? 0); ?></strong> of <strong class="text-stone-900"><?php echo e($sections->total()); ?></strong></p>
                        <div class="flex items-center gap-2">
                            <?php if($sections->onFirstPage()): ?>
                                <span class="page-link opacity-50 cursor-not-allowed">Previous</span>
                            <?php else: ?>
                                <a href="<?php echo e($sections->previousPageUrl()); ?>" class="page-link">Previous</a>
                            <?php endif; ?>
                            <?php $__currentLoopData = $sections->getUrlRange(1, $sections->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($sections->hasMorePages()): ?>
                                <a href="<?php echo e($sections->nextPageUrl()); ?>" class="page-link">Next</a>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.principal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\principal\sections\index.blade.php ENDPATH**/ ?>