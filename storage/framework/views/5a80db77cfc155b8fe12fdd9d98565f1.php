...
<head>
    ...
    <title>Students - <?php echo e($section->grade_level); ?> <?php echo e($section->name); ?></title>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 pl-4 border-l border-slate-200">
                        <div class="text-right hidden sm:block">
                            <p class="text-sm font-semibold text-slate-800"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></p>
                            <p class="text-xs text-slate-500">
                                <?php if($section->grade_level <= 3): ?>
                                    Primary Grade Teacher
                                <?php elseif($section->grade_level <= 6): ?>
                                    Intermediate Grade Teacher
                                <?php else: ?>
                                    Grade <?php echo e($section->grade_level); ?> Adviser
                                <?php endif; ?>
                            </p>
                        </div>
        ...
        <main class="p-6 max-w-7xl mx-auto">
            ...
            <div class="mb-8 animate-fade-in">
                <nav class="flex items-center gap-2 text-sm text-slate-500 mb-4">
                    ...
                    <a href="<?php echo e(route('teacher.sections.index')); ?>" class="hover:text-indigo-600 transition-colors">My Sections</a>
                    <i class="fas fa-chevron-right text-xs"></i>
                    <span class="text-slate-800 font-medium">Grade <?php echo e($section->grade_level); ?> - <?php echo e($section->name); ?></span>
                </nav>
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-1">
                            <h1 class="text-3xl font-bold text-slate-900">
                                Grade <?php echo e($section->grade_level); ?> - <?php echo e($section->name); ?>
                        ...
                        <p class="text-slate-500 flex items-center gap-2">
                            ...
                            Adviser: <span class="font-medium text-slate-700"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></span>
                            <span class="text-slate-300">|</span>
                            <i class="fas fa-school text-indigo-500"></i>
                            School Year: <?php echo e($section->schoolYear->name ?? ' '); ?>
                ...
                <div class="p-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="px-3 py-1 bg-indigo-50 text-indigo-700 text-xs font-semibold rounded-full border border-indigo-100">
                            Grade <?php echo e($section->grade_level); ?>

                        </span>
                        <?php if($section->max_capacity): ?>
                            <span class="px-3 py-1 bg-slate-100 text-slate-600 text-xs rounded-full">
                                Capacity: <?php echo e($students->total()); ?>/<?php echo e($section->max_capacity); ?>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors group student-row" 
                                    data-gender="<?php echo e(strtolower($user->gender ?? '')); ?>" 
                                    data-status="<?php echo e(strtolower($student->enrollment_status ?? 'active')); ?>">
                                    <td class="px-6 py-4">
                                        <input type="checkbox" class="student-checkbox rounded border-slate-300 text-indigo-600 focus:ring-indigo-500" value="<?php echo e($student->id); ?>">
                                    </td>
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="font-semibold text-slate-900 group-hover:text-indigo-600 transition-colors">
                                                    <?php echo e($user->last_name); ?>, <?php echo e($user->first_name); ?> <?php echo e($user->middle_name ? substr($user->middle_name, 0, 1) . '.' : ''); ?>

                                                </p>
                                                <p class="text-xs text-slate-500">
                                                    <?php if($section->grade_level == 'K'): ?>
                                                        Kindergarten
                                                    <?php else: ?>
                                                        Grade <?php echo e($section->grade_level); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="font-mono text-xs bg-slate-100 px-3 py-1.5 rounded-lg text-slate-600 font-medium tracking-wide">
                                            <?php echo e($student->lrn ?? $user->lrn ?? 'Not Assigned'); ?>
...
<td class="px-6 py-4">
    ...
    <div class="flex flex-col gap-1">
        ...
        <span class="text-slate-500 text-xs">
            <?php echo e($age ? $age . ' years old' : 'N/A'); ?>
    ...
    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium border <?php echo e($statusClass); ?>">
        <span class="w-1.5 h-1.5 rounded-full 
            <?php echo e($status == 'enrolled' ? 'bg-emerald-500' : 
               ($status == 'rejected' ? 'bg-red-500' : 
               ($status == 'approved' ? 'bg-blue-500' : 'bg-yellow-500'))); ?>">
        </span>

        <?php echo e(ucfirst($student->enrollment->status ?? 'Pending')); ?>
            ...
            <i class="fas fa-eye"></i>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-16">
                                        <div class="flex flex-col items-center justify-center text-slate-400">
                                            ...
                                            <a href="<?php echo e(route('teacher.students.create', $section->id)); ?>" 
                ...
                <div class="p-5 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <p class="text-sm text-slate-500">
                        Showing <span class="font-medium text-slate-900"><?php echo e($students->firstItem() ?? 0); ?></span> 
                        to <span class="font-medium text-slate-900"><?php echo e($students->lastItem() ?? 0); ?></span> 
                        of <span class="font-medium text-slate-900"><?php echo e($students->total()); ?></span> learners
                    </p>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in">
                 <a href="<?php echo e(route('teacher.sections.attendance', $section)); ?>" 
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-indigo-100 text-sm mb-4">Mark attendance for Grade <?php echo e($section->grade_level); ?></p>
...
</html><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\teacher\students\index.blade.php ENDPATH**/ ?>