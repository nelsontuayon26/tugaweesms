...
<?php $__env->startSection('header-title', 'Reports & Analytics Dashboard'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-xl p-6 shadow-lg" style="background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%);">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p style="color: #ffffff; font-size: 1.875rem; font-weight: 700; margin-top: 0.25rem;" id="stat-total-students"><?php echo e(number_format($stats['total_students'])); ?></p>
                        <p style="color: rgba(255,255,255,0.7); font-size: 0.75rem; margin-top: 0.5rem;">
                            <span id="stat-active-enrollments"><?php echo e(number_format($stats['active_enrollments'])); ?></span> active enrollments
                        </p>
                    </div>
            ...
            <div class="rounded-xl p-6 shadow-lg" style="background: linear-gradient(135deg, #10b981 0%, #34d399 100%);">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p style="color: #ffffff; font-size: 1.875rem; font-weight: 700; margin-top: 0.25rem;" id="stat-total-teachers"><?php echo e(number_format($stats['total_teachers'])); ?></p>
            ...
            <div class="rounded-xl p-6 shadow-lg" style="background: linear-gradient(135deg, #0ea5e9 0%, #06b6d4 100%);">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p style="color: #ffffff; font-size: 1.875rem; font-weight: 700; margin-top: 0.25rem;" id="stat-attendance-rate"><?php echo e($stats['today_attendance']['rate']); ?>%</p>
                        <p style="color: rgba(255,255,255,0.7); font-size: 0.75rem; margin-top: 0.5rem;">
                            <?php echo e($stats['today_attendance']['present']); ?> present / <?php echo e($stats['today_attendance']['total']); ?> total
                        </p>
                    </div>
                    <div style="background: rgba(255,255,255,0.2); border-radius: 0.5rem; padding: 0.75rem;">
                        <svg style="width: 2rem; height: 2rem; color: #ffffff;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="rounded-xl p-6 shadow-lg" style="background: linear-gradient(135deg, #f59e0b 0%, #ef4444 100%);">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p style="color: #ffffff; font-size: 1.875rem; font-weight: 700; margin-top: 0.25rem;" id="stat-total-sections"><?php echo e(number_format($stats['total_sections'])); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('principal.reports.builder', ['template' => 'student-masterlist'])); ?>" 
                    ...
                    <a href="<?php echo e(route('principal.reports.builder', ['template' => 'grade-summary'])); ?>" 
                    ...
                    <a href="<?php echo e(route('principal.reports.builder', ['template' => 'attendance-summary'])); ?>" 
                    ...
                    <a href="<?php echo e(route('principal.reports.builder', ['template' => 'honor-roll'])); ?>" 
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <?php if($favorites->count() > 0): ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $favorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer"
                                 onclick="runSavedReport(<?php echo e($report->id); ?>)">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500"><?php echo e($report->template->name); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">
                                            <?php echo e($report->last_run_at?->diffForHumans() ?? 'Never run'); ?>
        ...
        <div id="all-reports" class="bg-white rounded-xl shadow-sm p-6">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($categoryTemplates->count() > 0): ?>
                    <div class="template-category mb-8" id="category-<?php echo e($slug); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <?php $__currentLoopData = $categoryTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <a href="<?php echo e($templateUrl); ?>"
                                   class="report-card block p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:shadow-md transition-all">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-<?php echo e($template->color ?? 'blue'); ?>-100 flex items-center justify-center mr-3">
                                            <svg class="w-5 h-5 text-<?php echo e($template->color ?? 'blue'); ?>-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <?php echo $template->icon ?? '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>'; ?>

                                            </svg>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <h5 class="text-sm font-medium text-gray-900 truncate"><?php echo e($template->name); ?></h5>
                                            <p class="text-xs text-gray-500 mt-1 line-clamp-2"><?php echo e($template->description); ?></p>
...
<a href="<?php echo e(route('principal.dashboard')); ?>" 
...
<?php echo $__env->make('layouts.principal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\projects\capstone\tugaweesms-main\resources\views\principal\reports\index.blade.php ENDPATH**/ ?>